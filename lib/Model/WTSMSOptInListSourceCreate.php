...
/**
 * WTSMSOptInListSourceCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTSMSOptInListSourceCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTSMSOptInListSourceCreate';
    ...
    */
    ...
    public function setListId($list_id)
    {
        ...
        if ((mb_strlen($list_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $list_id when calling WTSMSOptInListSourceCreate., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($list_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $list_id when calling WTSMSOptInListSourceCreate., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($list_id)))) {
            throw new \InvalidArgumentException("invalid value for \$list_id when calling WTSMSOptInListSourceCreate., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setSourceName($source_name)
    {
        ...
        if (!is_null($source_name) && (mb_strlen($source_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source_name when calling WTSMSOptInListSourceCreate., must be bigger than or equal to 1.');
        }
