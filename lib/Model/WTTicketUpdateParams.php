...
class WTTicketUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets is_comp
     *
     * @param mixed|null $is_comp is_comp
     *
     * @return self
     */
    ...
    {
        if (is_null($is_comp)) {
            array_push($this->openAPINullablesSetToNull, 'is_comp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_comp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets quantity
     *
     * @param mixed|null $quantity The number of tickets allocated to the recipient.
     *
     * @return self
     */
