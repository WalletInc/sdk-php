...
class WTEmployeeScheduleSimpleSMSToRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('to_cell_phone', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets to_cell_phone
     *
     * @param mixed $to_cell_phone to_cell_phone
     *
     * @return self
     */
    public function setToCellPhone($to_cell_phone)
    {
        if (is_null($to_cell_phone)) {
            array_push($this->openAPINullablesSetToNull, 'to_cell_phone');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_cell_phone', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($to_cell_phone) && (mb_strlen($to_cell_phone) < 1)) {
