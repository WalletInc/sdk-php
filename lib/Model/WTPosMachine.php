...
class WTPosMachine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setRegisterId($register_id)
    {
        ...
        if (!is_null($register_id) && (mb_strlen($register_id) < 1)) {
     ...
     * Sets register_name
     *
     * @param mixed $register_name register_name
     *
     * @return self
     */
    public function setRegisterName($register_name)
    {
        if (is_null($register_name)) {
            array_push($this->openAPINullablesSetToNull, 'register_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('register_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($register_name) && (mb_strlen($register_name) < 1)) {
     ...
     * Sets outlet_name
     *
     * @param mixed $outlet_name outlet_name
     *
     * @return self
     */
    public function setOutletName($outlet_name)
    {
        if (is_null($outlet_name)) {
            array_push($this->openAPINullablesSetToNull, 'outlet_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outlet_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($outlet_name) && (mb_strlen($outlet_name) < 1)) {
    ...
    public function setOutletNumber($outlet_number)
    {
        if (is_null($outlet_number)) {
            array_push($this->openAPINullablesSetToNull, 'outlet_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outlet_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets profit_center
     *
     * @param mixed $profit_center profit_center
     *
     * @return self
     */
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) < 1)) {
