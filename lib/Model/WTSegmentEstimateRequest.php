...
/**
 * WTSegmentEstimateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTSegmentEstimateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTSegmentEstimateRequest';
    ...
    */
     ...
     * Sets has_media
     *
     * @param mixed|null $has_media has_media
     *
     * @return self
     */
    public function setHasMedia($has_media)
    {
        if (is_null($has_media)) {
            array_push($this->openAPINullablesSetToNull, 'has_media');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('has_media', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $recipient_count recipient_count
     *
     * @return self
     */
