...
/**
 * WTVideoUploadPresignParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTVideoUploadPresignParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTVideoUploadPresignParams';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling WTVideoUploadPresignParams., must be bigger than or equal to 1.');
        }
    ...
    public function setFileType($file_type)
    {
        ...
        if (!is_null($file_type) && (mb_strlen($file_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_type when calling WTVideoUploadPresignParams., must be bigger than or equal to 1.');
        }
