...
class MSMembershipTierRedemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets member_id
     *
     * @param string $member_id A 10 character alphanumeric unique value that represents each member
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount that has been redeemed, in cents
     *
     * @return self
     */
     ...
     * Sets tier_id
     *
     * @param string $tier_id A 10 character alphanumeric unique value that represents each membership tier
     *
     * @return self
     */
