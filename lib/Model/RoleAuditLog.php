...
class RoleAuditLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'action_by_employee_name' => 'mixed',
        'action_on_employee_id' => 'string',
        'action_on_employee_name' => 'mixed',
        'display_name' => 'mixed',
        'is_system' => 'mixed'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'action' => true,
        'merchant_id' => false,
        'action_by_employee_id' => false,
        'action_by_employee_name' => true,
        'action_on_employee_id' => false,
        'action_on_employee_name' => true,
        'display_name' => true,
        'is_system' => true
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('action_by_employee_id', $data ?? [], null);
        $this->setIfExists('action_by_employee_name', $data ?? [], null);
        $this->setIfExists('action_on_employee_id', $data ?? [], null);
        $this->setIfExists('action_on_employee_name', $data ?? [], null);
    ...
    */
     ...
     * Sets role_name
     *
     * @param mixed $role_name role_name
     *
     * @return self
     */
    ...
    {
        if (is_null($action_by_employee_id)) {
            throw new \InvalidArgumentException('non-nullable action_by_employee_id cannot be null');
        }
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($action_by_employee_id)))) {
     ...
     *
     * @param mixed $action_by_employee_name action_by_employee_name
     *
     * @return self
     */
    public function setActionByEmployeeName($action_by_employee_name)
    {
        if (is_null($action_by_employee_name)) {
            array_push($this->openAPINullablesSetToNull, 'action_by_employee_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('action_by_employee_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($action_on_employee_id)) {
            throw new \InvalidArgumentException('non-nullable action_on_employee_id cannot be null');
        }
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($action_on_employee_id)))) {
     ...
     *
     * @param mixed $action_on_employee_name action_on_employee_name
     *
     * @return self
     */
    public function setActionOnEmployeeName($action_on_employee_name)
    {
        if (is_null($action_on_employee_name)) {
            array_push($this->openAPINullablesSetToNull, 'action_on_employee_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('action_on_employee_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets display_name
     *
     * @param mixed $display_name display_name
     *
     * @return self
     */
     ...
     * Sets is_system
     *
     * @param mixed $is_system is_system
     *
     * @return self
     */
