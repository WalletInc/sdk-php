...
class RoleAuditLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'action_by_employee_name' => false,
        'action_on_employee_id' => false,
        'action_on_employee_name' => false,
        'display_name' => false,
        'is_system' => false
    ];
    ...
    */
    ...
    public function setActionByEmployeeName($action_by_employee_name)
    {
        if (is_null($action_by_employee_name)) {
            throw new \InvalidArgumentException('non-nullable action_by_employee_name cannot be null');
        }
    ...
    public function setActionOnEmployeeName($action_on_employee_name)
    {
        if (is_null($action_on_employee_name)) {
            throw new \InvalidArgumentException('non-nullable action_on_employee_name cannot be null');
        }
