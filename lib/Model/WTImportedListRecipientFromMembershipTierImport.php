...
class WTImportedListRecipientFromMembershipTierImport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-zA-Z0-9]+$/", $this->container['tier_id'])) {
            $invalidProperties[] = "invalid value for 'tier_id', must be conform to the pattern /^[a-zA-Z0-9]+$/.";
        }
    ...
    public function setTierId($tier_id)
    {
        if ((mb_strlen($tier_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_id when calling WTImportedListRecipientFromMembershipTierImport., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($tier_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_id when calling WTImportedListRecipientFromMembershipTierImport., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $tier_id))) {
            throw new \InvalidArgumentException("invalid value for $tier_id when calling WTImportedListRecipientFromMembershipTierImport., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
