    ...
    */
    ...
    public function setInstagram($instagram)
    {
        ...
        if (!is_null($instagram) && ($instagram < 0)) {
            throw new \InvalidArgumentException('invalid value for $instagram when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setFacebook($facebook)
    {
        ...
        if (!is_null($facebook) && ($facebook < 0)) {
            throw new \InvalidArgumentException('invalid value for $facebook when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setYouTube($you_tube)
    {
        ...
        if (!is_null($you_tube) && ($you_tube < 0)) {
            throw new \InvalidArgumentException('invalid value for $you_tube when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTwitter($twitter)
    {
        ...
        if (!is_null($twitter) && ($twitter < 0)) {
            throw new \InvalidArgumentException('invalid value for $twitter when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setLinkedIn($linked_in)
    {
        ...
        if (!is_null($linked_in) && ($linked_in < 0)) {
            throw new \InvalidArgumentException('invalid value for $linked_in when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTikTok($tik_tok)
    {
        ...
        if (!is_null($tik_tok) && ($tik_tok < 0)) {
            throw new \InvalidArgumentException('invalid value for $tik_tok when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setWhatsApp($whats_app)
    {
        ...
        if (!is_null($whats_app) && ($whats_app < 0)) {
            throw new \InvalidArgumentException('invalid value for $whats_app when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
    ...
    public function setAvatarUrl($avatar_url)
    {
        ...
        if (!is_null($avatar_url) && ($avatar_url < 0)) {
            throw new \InvalidArgumentException('invalid value for $avatar_url when calling WTVirtualBusinessCardUpdateParams., must be bigger than or equal to 0.');
        }
