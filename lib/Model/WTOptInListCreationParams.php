...
class WTOptInListCreationParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'estimated_messages_per_month' => 'mixed',
        'opt_in_keyword' => 'mixed',
        'opt_out_keyword' => 'mixed',
        'opt_in_confirmed_response' => 'mixed',
        'opt_out_confirmed_response' => 'mixed',
        'opt_in_confirmed_customer_receives' => 'mixed',
        'opt_out_confirmed_customer_receives' => 'mixed',
        'is_over21_required' => 'mixed',
    ...
    protected static array $openAPINullables = [
        ...
        'estimated_messages_per_month' => true,
        'opt_in_keyword' => true,
        'opt_out_keyword' => true,
        'opt_in_confirmed_response' => true,
        'opt_out_confirmed_response' => true,
        'opt_in_confirmed_customer_receives' => true,
        'opt_out_confirmed_customer_receives' => true,
        'is_over21_required' => true,
        'opt_in_confirmed_media_urls' => true,
        'opt_out_confirmed_media_urls' => true
    ];
    ...
    */
     ...
     * Sets list_name
     *
     * @param mixed $list_name list_name
     *
     * @return self
     */
    public function setListName($list_name)
    {
        if (is_null($list_name)) {
            array_push($this->openAPINullablesSetToNull, 'list_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('list_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($list_name) && (mb_strlen($list_name) < 1)) {
     ...
     *
     * @param mixed $estimated_messages_per_month estimated_messages_per_month
     *
     * @return self
     */
    public function setEstimatedMessagesPerMonth($estimated_messages_per_month)
    {
        if (is_null($estimated_messages_per_month)) {
            array_push($this->openAPINullablesSetToNull, 'estimated_messages_per_month');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('estimated_messages_per_month', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($estimated_messages_per_month) && ($estimated_messages_per_month < 0)) {
     ...
     * Sets opt_in_keyword
     *
     * @param mixed $opt_in_keyword opt_in_keyword
     *
     * @return self
     */
    public function setOptInKeyword($opt_in_keyword)
    {
        if (is_null($opt_in_keyword)) {
            array_push($this->openAPINullablesSetToNull, 'opt_in_keyword');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_in_keyword', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($opt_in_keyword) && (mb_strlen($opt_in_keyword) > 30)) {
        ...
        if (!is_null($opt_in_keyword) && (mb_strlen($opt_in_keyword) < 4)) {
     ...
     *
     * @param mixed $opt_out_keyword opt_out_keyword
     *
     * @return self
     */
    public function setOptOutKeyword($opt_out_keyword)
    {
        if (is_null($opt_out_keyword)) {
            array_push($this->openAPINullablesSetToNull, 'opt_out_keyword');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_out_keyword', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($opt_out_keyword) && (mb_strlen($opt_out_keyword) > 34)) {
        ...
        if (!is_null($opt_out_keyword) && (mb_strlen($opt_out_keyword) < 4)) {
     ...
     *
     * @param mixed $opt_in_confirmed_response opt_in_confirmed_response
     *
     * @return self
     */
    public function setOptInConfirmedResponse($opt_in_confirmed_response)
    {
        if (is_null($opt_in_confirmed_response)) {
            array_push($this->openAPINullablesSetToNull, 'opt_in_confirmed_response');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_in_confirmed_response', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $opt_out_confirmed_response opt_out_confirmed_response
     *
     * @return self
     */
    public function setOptOutConfirmedResponse($opt_out_confirmed_response)
    {
        if (is_null($opt_out_confirmed_response)) {
            array_push($this->openAPINullablesSetToNull, 'opt_out_confirmed_response');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_out_confirmed_response', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $opt_in_confirmed_customer_receives opt_in_confirmed_customer_receives
     *
     * @return self
     */
    public function setOptInConfirmedCustomerReceives($opt_in_confirmed_customer_receives)
    {
        if (is_null($opt_in_confirmed_customer_receives)) {
            array_push($this->openAPINullablesSetToNull, 'opt_in_confirmed_customer_receives');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_in_confirmed_customer_receives', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $opt_out_confirmed_customer_receives opt_out_confirmed_customer_receives
     *
     * @return self
     */
    public function setOptOutConfirmedCustomerReceives($opt_out_confirmed_customer_receives)
    {
        if (is_null($opt_out_confirmed_customer_receives)) {
            array_push($this->openAPINullablesSetToNull, 'opt_out_confirmed_customer_receives');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_out_confirmed_customer_receives', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $is_over21_required is_over21_required
     *
     * @return self
     */
    public function setIsOver21Required($is_over21_required)
    {
        if (is_null($is_over21_required)) {
            array_push($this->openAPINullablesSetToNull, 'is_over21_required');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_over21_required', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $opt_in_confirmed_media_urls opt_in_confirmed_media_urls
     *
     * @return self
     */
    public function setOptInConfirmedMediaUrls($opt_in_confirmed_media_urls)
    {
        if (is_null($opt_in_confirmed_media_urls)) {
            array_push($this->openAPINullablesSetToNull, 'opt_in_confirmed_media_urls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_in_confirmed_media_urls', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $opt_out_confirmed_media_urls opt_out_confirmed_media_urls
     *
     * @return self
     */
    public function setOptOutConfirmedMediaUrls($opt_out_confirmed_media_urls)
    {
        if (is_null($opt_out_confirmed_media_urls)) {
            array_push($this->openAPINullablesSetToNull, 'opt_out_confirmed_media_urls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_out_confirmed_media_urls', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
