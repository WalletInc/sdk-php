...
class PromoCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets promo_code
     *
     * @param mixed $promo_code promo_code
     *
     * @return self
     */
    public function setPromoCode($promo_code)
    {
        ...
        if (!is_null($promo_code) && (mb_strlen($promo_code) < 1)) {
     ...
     * Sets display_value
     *
     * @param mixed $display_value display_value
     *
     * @return self
     */
    public function setDisplayValue($display_value)
    {
        ...
        if (!is_null($display_value) && (mb_strlen($display_value) < 1)) {
