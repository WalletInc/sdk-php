...
class ClickFunnelContactProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'middle_name' => true,
        'websites' => true,
        'location_general' => true,
        'normalized_location' => true,
        'deduced_location' => true,
        'age' => true,
        'gender' => true,
        'age_range_lower' => true,
        'age_range_upper' => true,
        'action_score' => true,
        'known_ltv' => false,
        'tags' => true,
        'time_zone' => true,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('location_general', $data ?? [], null);
        $this->setIfExists('normalized_location', $data ?? [], null);
        $this->setIfExists('deduced_location', $data ?? [], null);
        $this->setIfExists('age', $data ?? [], null);
        $this->setIfExists('gender', $data ?? [], null);
        $this->setIfExists('age_range_lower', $data ?? [], null);
        $this->setIfExists('age_range_upper', $data ?? [], null);
        $this->setIfExists('action_score', $data ?? [], null);
        $this->setIfExists('known_ltv', $data ?? [], null);
        $this->setIfExists('tags', $data ?? [], null);
        $this->setIfExists('time_zone', $data ?? [], null);
        $this->setIfExists('lists_names', $data ?? [], null);
        $this->setIfExists('globally_unsubscribed', $data ?? [], null);
    }
    ...
    */
    ...
    public function setShippingCity($shipping_city)
    {
        if (is_null($shipping_city)) {
            array_push($this->openAPINullablesSetToNull, 'shipping_city');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipping_city', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setShippingState($shipping_state)
    {
        if (is_null($shipping_state)) {
            array_push($this->openAPINullablesSetToNull, 'shipping_state');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipping_state', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setShippingZip($shipping_zip)
    {
        if (is_null($shipping_zip)) {
            array_push($this->openAPINullablesSetToNull, 'shipping_zip');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipping_zip', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($location_general)) {
            array_push($this->openAPINullablesSetToNull, 'location_general');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('location_general', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($normalized_location)) {
            array_push($this->openAPINullablesSetToNull, 'normalized_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('normalized_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($deduced_location)) {
            array_push($this->openAPINullablesSetToNull, 'deduced_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deduced_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($age_range_lower)) {
            array_push($this->openAPINullablesSetToNull, 'age_range_lower');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('age_range_lower', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($age_range_upper)) {
            array_push($this->openAPINullablesSetToNull, 'age_range_upper');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('age_range_upper', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($action_score)) {
            array_push($this->openAPINullablesSetToNull, 'action_score');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('action_score', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($known_ltv)) {
            throw new \InvalidArgumentException('non-nullable known_ltv cannot be null');
        }
    ...
    {
        if (is_null($lists_names)) {
            throw new \InvalidArgumentException('non-nullable lists_names cannot be null');
        }
    ...
    {
        if (is_null($globally_unsubscribed)) {
            throw new \InvalidArgumentException('non-nullable globally_unsubscribed cannot be null');
        }
