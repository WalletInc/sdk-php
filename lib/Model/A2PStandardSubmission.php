...
/**
 * A2PStandardSubmission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class A2PStandardSubmission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A2PStandardSubmission';
    ...
    protected static $openAPITypes = [
        ...
        'last_name' => 'mixed',
        'email' => 'mixed',
        'business_classification' => '\OpenAPI\Client\Model\BusinessClassificationPrivate',
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) < 6)) {
            throw new \InvalidArgumentException('invalid length for $email when calling A2PStandardSubmission., must be bigger than or equal to 6.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\BusinessClassificationPrivate
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BusinessClassificationPrivate $business_classification business_classification
     *
     * @return self
     */
    ...
    public function setTaxId($tax_id)
    {
        ...
        if (!is_null($tax_id) && (mb_strlen($tax_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_id when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setWebsiteUrl($website_url)
    {
        ...
        if (!is_null($website_url) && (mb_strlen($website_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $website_url when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setSocialMediaUrl($social_media_url)
    {
        ...
        if (!is_null($social_media_url) && (mb_strlen($social_media_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $social_media_url when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setMessagingVolumeHigh($messaging_volume_high)
    {
        ...
        if (!is_null($messaging_volume_high) && (mb_strlen($messaging_volume_high) < 1)) {
            throw new \InvalidArgumentException('invalid length for $messaging_volume_high when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if (!is_null($job_title) && (mb_strlen($job_title) < 2)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling A2PStandardSubmission., must be bigger than or equal to 2.');
        }
    ...
    public function setBusinessName($business_name)
    {
        ...
        if (!is_null($business_name) && (mb_strlen($business_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address1)
    {
        ...
        if (!is_null($address1) && (mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling A2PStandardSubmission., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $city when calling A2PStandardSubmission., must be bigger than or equal to 3.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling A2PStandardSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling A2PStandardSubmission., must be bigger than or equal to 4.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling A2PStandardSubmission., must be bigger than or equal to 2.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 7)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling A2PStandardSubmission., must be bigger than or equal to 7.');
        }
