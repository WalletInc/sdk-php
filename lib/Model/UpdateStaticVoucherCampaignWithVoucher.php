...
class UpdateStaticVoucherCampaignWithVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['voucher_id']) > 12)) {
            $invalidProperties[] = "invalid value for 'voucher_id', the character length must be smaller than or equal to 12.";
        }

        if ((mb_strlen($this->container['voucher_id']) < 10)) {
            $invalidProperties[] = "invalid value for 'voucher_id', the character length must be bigger than or equal to 10.";
        }

        if (!preg_match("/^[a-zA-Z0-9]+$/", $this->container['voucher_id'])) {
            $invalidProperties[] = "invalid value for 'voucher_id', must be conform to the pattern /^[a-zA-Z0-9]+$/.";
        }
     ...
     * Sets cell_phone
     *
     * @param mixed|null $cell_phone cell_phone
     *
     * @return self
     */
    ...
    public function setVoucherId($voucher_id)
    {
        ...
        if ((mb_strlen($voucher_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $voucher_id when calling UpdateStaticVoucherCampaignWithVoucher., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($voucher_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $voucher_id when calling UpdateStaticVoucherCampaignWithVoucher., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($voucher_id)))) {
            throw new \InvalidArgumentException("invalid value for \$voucher_id when calling UpdateStaticVoucherCampaignWithVoucher., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
