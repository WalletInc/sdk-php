    ...
    */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Thread., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Thread., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling Thread., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets thread_id
     *
     * @param mixed $thread_id thread_id
     *
     * @return self
     */
    public function setThreadId($thread_id)
    {
        ...
        if (!is_null($thread_id) && (mb_strlen($thread_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thread_id when calling Thread., must be bigger than or equal to 1.');
        }
