...
class DynamicVoucherBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPaymentObjectPrefix($payment_object_prefix)
    {
        if ((mb_strlen($payment_object_prefix) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_prefix when calling DynamicVoucherBroadcast., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payment_object_prefix) < 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_prefix when calling DynamicVoucherBroadcast., must be bigger than or equal to 2.');
        }
    ...
    {
        if ((mb_strlen($id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DynamicVoucherBroadcast., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DynamicVoucherBroadcast., must be bigger than or equal to 10.');
        }
