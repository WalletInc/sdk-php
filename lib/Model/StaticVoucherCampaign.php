...
class StaticVoucherCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'is_active' => false,
        'voucher_type' => false,
        'reinvestment_sum_decimal' => false,
        'reinvestment_sum_string' => false,
        'start_date' => false,
    ...
    */
    ...
    public function setReinvestmentSumDecimal($reinvestment_sum_decimal)
    {
        if (is_null($reinvestment_sum_decimal)) {
            throw new \InvalidArgumentException('non-nullable reinvestment_sum_decimal cannot be null');
        }
    ...
    public function setReinvestmentSumString($reinvestment_sum_string)
    {
        if (is_null($reinvestment_sum_string)) {
            throw new \InvalidArgumentException('non-nullable reinvestment_sum_string cannot be null');
        }
