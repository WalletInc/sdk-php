...
class StaticVoucherCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'mixed',
        'notes' => 'mixed',
        'value_type' => '\OpenAPI\Client\Model\StaticVoucherCampaignValueType',
        'is_loaded' => 'mixed',
        'display_value' => 'mixed',
        ...
        'employee_id' => 'string',
        'reinvestment_sum' => 'mixed',
        'number_of_vouchers_in_file' => 'mixed',
        'campaign_group_id' => 'string',
        'bucket' => 'mixed',
        'created_by_source_id' => 'mixed',
        ...
        'is_active' => 'mixed',
        'voucher_type' => 'mixed',
        'reinvestment_sum_decimal' => 'mixed',
        'reinvestment_sum_string' => 'mixed',
        'start_date' => 'mixed',
    ...
    protected static array $openAPINullables = [
        ...
        'employee_id' => false,
        'reinvestment_sum' => true,
        'number_of_vouchers_in_file' => true,
        'campaign_group_id' => false,
        'bucket' => true,
        'created_by_source_id' => true,
        ...
        'is_active' => true,
        'voucher_type' => true,
        'reinvestment_sum_decimal' => true,
        'reinvestment_sum_string' => true,
        'start_date' => true,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reinvestment_sum_decimal', $data ?? [], null);
        $this->setIfExists('reinvestment_sum_string', $data ?? [], null);
    ...
    */
     ...
     * Gets value_type
     *
     * @return \OpenAPI\Client\Model\StaticVoucherCampaignValueType
     */
     ...
     * Sets value_type
     *
     * @param \OpenAPI\Client\Model\StaticVoucherCampaignValueType $value_type value_type
     *
     * @return self
     */
     ...
     * Sets is_loaded
     *
     * @param mixed $is_loaded is_loaded
     *
     * @return self
     */
    public function setIsLoaded($is_loaded)
    {
        if (is_null($is_loaded)) {
            array_push($this->openAPINullablesSetToNull, 'is_loaded');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_loaded', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets display_value
     *
     * @param mixed|null $display_value display_value
     *
     * @return self
     */
     ...
     *
     * @param mixed $reinvestment_sum reinvestment_sum
     *
     * @return self
     */
    public function setReinvestmentSum($reinvestment_sum)
    {
        if (is_null($reinvestment_sum)) {
            array_push($this->openAPINullablesSetToNull, 'reinvestment_sum');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reinvestment_sum', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($reinvestment_sum) && ($reinvestment_sum < 0)) {
     ...
     *
     * @param mixed $number_of_vouchers_in_file number_of_vouchers_in_file
     *
     * @return self
     */
    public function setNumberOfVouchersInFile($number_of_vouchers_in_file)
    {
        if (is_null($number_of_vouchers_in_file)) {
            array_push($this->openAPINullablesSetToNull, 'number_of_vouchers_in_file');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('number_of_vouchers_in_file', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($number_of_vouchers_in_file) && ($number_of_vouchers_in_file < 0)) {
     ...
     * Sets bucket
     *
     * @param mixed|null $bucket bucket
     *
     * @return self
     */
     ...
     *
     * @param mixed $created_by_source_id created_by_source_id
     *
     * @return self
     */
    public function setCreatedBySourceId($created_by_source_id)
    {
        if (is_null($created_by_source_id)) {
            array_push($this->openAPINullablesSetToNull, 'created_by_source_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('created_by_source_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $original_file_name original_file_name
     *
     * @return self
     */
     ...
     * Sets voucher_type
     *
     * @param mixed $voucher_type voucher_type
     *
     * @return self
     */
     ...
     *
     * @param mixed $reinvestment_sum_decimal reinvestment_sum_decimal
     *
     * @return self
     */
    public function setReinvestmentSumDecimal($reinvestment_sum_decimal)
    {
        if (is_null($reinvestment_sum_decimal)) {
            array_push($this->openAPINullablesSetToNull, 'reinvestment_sum_decimal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reinvestment_sum_decimal', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $reinvestment_sum_string reinvestment_sum_string
     *
     * @return self
     */
    public function setReinvestmentSumString($reinvestment_sum_string)
    {
        if (is_null($reinvestment_sum_string)) {
            array_push($this->openAPINullablesSetToNull, 'reinvestment_sum_string');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reinvestment_sum_string', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
