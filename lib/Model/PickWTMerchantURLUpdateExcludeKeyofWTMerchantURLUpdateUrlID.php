...
/**
 * PickWTMerchantURLUpdateExcludeKeyofWTMerchantURLUpdateUrlID Class Doc Comment
 *
 * @category Class
 ...
 */
class PickWTMerchantURLUpdateExcludeKeyofWTMerchantURLUpdateUrlID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_WTMerchantURLUpdate.Exclude_keyofWTMerchantURLUpdate.urlID__';
    ...
    */
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling PickWTMerchantURLUpdateExcludeKeyofWTMerchantURLUpdateUrlID., must be bigger than or equal to 1.');
        }
    ...
    public function setDestinationUrl($destination_url)
    {
        ...
        if ((mb_strlen($destination_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination_url when calling PickWTMerchantURLUpdateExcludeKeyofWTMerchantURLUpdateUrlID., must be bigger than or equal to 1.');
        }
