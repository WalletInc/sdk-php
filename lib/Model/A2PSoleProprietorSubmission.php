...
/**
 * A2PSoleProprietorSubmission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class A2PSoleProprietorSubmission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A2PSoleProprietorSubmission';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'mixed',
        'business_name' => 'mixed',
        'business_type' => '\OpenAPI\Client\Model\BusinessTypeSoleProprietorship',
        'address1' => 'mixed',
        'address2' => 'mixed',
        'city' => 'mixed',
        'state' => 'mixed',
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling A2PSoleProprietorSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling A2PSoleProprietorSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) < 6)) {
            throw new \InvalidArgumentException('invalid length for $email when calling A2PSoleProprietorSubmission., must be bigger than or equal to 6.');
        }
    ...
    public function setBusinessName($business_name)
    {
        ...
        if (!is_null($business_name) && (mb_strlen($business_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling A2PSoleProprietorSubmission., must be bigger than or equal to 1.');
        }
     ...
     * Gets business_type
     *
     * @return \OpenAPI\Client\Model\BusinessTypeSoleProprietorship
     */
     ...
     * Sets business_type
     *
     * @param \OpenAPI\Client\Model\BusinessTypeSoleProprietorship $business_type business_type
     *
     * @return self
     */
    ...
    public function setAddress1($address1)
    {
        ...
        if (!is_null($address1) && (mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling A2PSoleProprietorSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling A2PSoleProprietorSubmission., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $city when calling A2PSoleProprietorSubmission., must be bigger than or equal to 3.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling A2PSoleProprietorSubmission., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling A2PSoleProprietorSubmission., must be bigger than or equal to 4.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling A2PSoleProprietorSubmission., must be bigger than or equal to 2.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 7)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling A2PSoleProprietorSubmission., must be bigger than or equal to 7.');
        }
     ...
     *
     * @param string $verification_mobile verification_mobile
     *
     * @return self
     */
    public function setVerificationMobile($verification_mobile)
    {
        if (is_null($verification_mobile)) {
            throw new \InvalidArgumentException('non-nullable verification_mobile cannot be null');
        }
