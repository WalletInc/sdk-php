...
/**
 * WTMerchantURLUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTMerchantURLUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTMerchantURLUpdate';
    ...
    */
    ...
    public function setNickname($nickname)
    {
        ...
        if ((mb_strlen($nickname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling WTMerchantURLUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setDestinationUrl($destination_url)
    {
        ...
        if ((mb_strlen($destination_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination_url when calling WTMerchantURLUpdate., must be bigger than or equal to 1.');
        }
