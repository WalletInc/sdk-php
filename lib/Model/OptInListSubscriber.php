...
class OptInListSubscriber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'opt_in_source_id' => '\OpenAPI\Client\Model\OptInListSubscriberOptInSourceID',
        'is_subscribed' => 'mixed',
        'is_pending_age21_verification' => 'mixed',
    ...
    */
     ...
     * Sets caller_name
     *
     * @param mixed|null $caller_name caller_name
     *
     * @return self
     */
    public function setCallerName($caller_name)
    {
        if (is_null($caller_name)) {
            ...
            $index = array_search('caller_name', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets caller_type
     *
     * @param mixed|null $caller_type caller_type
     *
     * @return self
     */
    public function setCallerType($caller_type)
    {
        if (is_null($caller_type)) {
            array_push($this->openAPINullablesSetToNull, 'caller_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('caller_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \OpenAPI\Client\Model\OptInListSubscriberOptInSourceID
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OptInListSubscriberOptInSourceID $opt_in_source_id opt_in_source_id
     *
     * @return self
     */
     ...
     * Sets is_subscribed
     *
     * @param mixed $is_subscribed is_subscribed
     *
     * @return self
     */
     ...
     *
     * @param mixed $is_pending_age21_verification is_pending_age21_verification
     *
     * @return self
     */
    public function setIsPendingAge21Verification($is_pending_age21_verification)
    {
        if (is_null($is_pending_age21_verification)) {
            array_push($this->openAPINullablesSetToNull, 'is_pending_age21_verification');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_pending_age21_verification', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets referring_url
     *
     * @param mixed $referring_url referring_url
     *
     * @return self
     */
    public function setReferringUrl($referring_url)
    {
        if (is_null($referring_url)) {
            array_push($this->openAPINullablesSetToNull, 'referring_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('referring_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($referring_url) && (mb_strlen($referring_url) < 0)) {
