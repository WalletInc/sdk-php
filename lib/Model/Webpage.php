...
class Webpage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets admin_page
     *
     * @param mixed $admin_page admin_page
     *
     * @return self
     */
    public function setAdminPage($admin_page)
    {
        if (is_null($admin_page)) {
            array_push($this->openAPINullablesSetToNull, 'admin_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('admin_page', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets system_name
     *
     * @param mixed $system_name system_name
     *
     * @return self
     */
     ...
     * Sets is_public
     *
     * @param mixed $is_public is_public
     *
     * @return self
     */
    public function setIsPublic($is_public)
    {
        if (is_null($is_public)) {
            array_push($this->openAPINullablesSetToNull, 'is_public');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_public', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
