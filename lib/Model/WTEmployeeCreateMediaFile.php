...
/**
 * WTEmployeeCreateMediaFile Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTEmployeeCreateMediaFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTEmployeeCreateMediaFile';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling WTEmployeeCreateMediaFile., must be bigger than or equal to 1.');
        }
     ...
     * Sets file_data
     *
     * @param mixed $file_data file_data
     *
     * @return self
     */
     ...
     * Sets folder
     *
     * @param mixed|null $folder folder
     *
     * @return self
     */
