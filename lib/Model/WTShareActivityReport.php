...
/**
 * WTShareActivityReport Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTShareActivityReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTShareActivityReport';
    ...
    protected static $openAPITypes = [
        ...
        'window_days' => 'mixed',
        'rows' => 'mixed',
        'totals' => '\OpenAPI\Client\Model\WTShareActivityRow'
    ];
    ...
    */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTShareActivityReport., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTShareActivityReport., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling WTShareActivityReport., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets window_days
     *
     * @param mixed $window_days window_days
     *
     * @return self
     */
     ...
     * Gets totals
     *
     * @return \OpenAPI\Client\Model\WTShareActivityRow
     */
     ...
     * Sets totals
     *
     * @param \OpenAPI\Client\Model\WTShareActivityRow $totals totals
     *
     * @return self
     */
