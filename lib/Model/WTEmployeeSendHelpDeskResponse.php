...
class WTEmployeeSendHelpDeskResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('help_desk_request_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($help_desk_request_id)) {
            throw new \InvalidArgumentException('non-nullable help_desk_request_id cannot be null');
        }
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($help_desk_request_id)))) {
