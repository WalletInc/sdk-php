...
/**
 * WTCustomerSearchByMemberID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTCustomerSearchByMemberID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTCustomerSearchByMemberID';
    ...
    */
     ...
     * Sets member_id
     *
     * @param mixed $member_id member_id
     *
     * @return self
     */
    public function setMemberId($member_id)
    {
        ...
        if (!is_null($member_id) && (mb_strlen($member_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $member_id when calling WTCustomerSearchByMemberID., must be bigger than or equal to 1.');
        }
