...
/**
 * PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym Class Doc Comment
 *
 * @category Class
 ...
 */
class PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_VSPaymentDesignCreateParams.Exclude_keyofVSPaymentDesignCreateParams.employeeID-or-abbreviation-or-acronym__';
    ...
    */
    ...
    public function setBorderColor($border_color)
    {
        ...
        if ((!preg_match("/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/", ObjectSerializer::toString($border_color)))) {
            throw new \InvalidArgumentException("invalid value for \$border_color when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must conform to the pattern /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.");
        }
    ...
    public function setBorderSize($border_size)
    {
        ...
        if ((mb_strlen($border_size) < 1)) {
            throw new \InvalidArgumentException('invalid length for $border_size when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 1.');
        }
    ...
    public function setBorderRadius($border_radius)
    {
        ...
        if (($border_radius > 20)) {
            throw new \InvalidArgumentException('invalid value for $border_radius when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be smaller than or equal to 20.');
        }
        if (($border_radius < 0)) {
            throw new \InvalidArgumentException('invalid value for $border_radius when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 0.');
        }
    ...
    public function setFontColor($font_color)
    {
        ...
        if ((!preg_match("/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/", ObjectSerializer::toString($font_color)))) {
            throw new \InvalidArgumentException("invalid value for \$font_color when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must conform to the pattern /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.");
        }
    ...
    public function setFontType($font_type)
    {
        ...
        if ((mb_strlen($font_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $font_type when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 1.');
        }
    ...
    public function setDesignName($design_name)
    {
        ...
        if ((mb_strlen($design_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $design_name when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PickVSPaymentDesignCreateParamsExcludeKeyofVSPaymentDesignCreateParamsEmployeeIDOrAbbreviationOrAcronym., must be bigger than or equal to 1.');
        }
