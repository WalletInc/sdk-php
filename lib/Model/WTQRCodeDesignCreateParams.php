...
class WTQRCodeDesignCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCornerRadius($corner_radius)
    {
        ...
        if (($corner_radius < 1)) {
            throw new \InvalidArgumentException('invalid value for $corner_radius when calling WTQRCodeDesignCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setColorDarkHex($color_dark_hex)
    {
        ...
        if ((mb_strlen($color_dark_hex) < 1)) {
            throw new \InvalidArgumentException('invalid length for $color_dark_hex when calling WTQRCodeDesignCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setLogoImageUrl($logo_image_url)
    {
        ...
        if ((mb_strlen($logo_image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_image_url when calling WTQRCodeDesignCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setBackgroundImageUrl($background_image_url)
    {
        ...
        if ((mb_strlen($background_image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $background_image_url when calling WTQRCodeDesignCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setAnimatedGifBackgroundUrl($animated_gif_background_url)
    {
        ...
        if ((mb_strlen($animated_gif_background_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $animated_gif_background_url when calling WTQRCodeDesignCreateParams., must be bigger than or equal to 1.');
        }
