...
/**
 * MSMembershipTierHistory Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MSMembershipTierHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MSMembershipTierHistory';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['tier_id']) > 10)) {
            $invalidProperties[] = "invalid value for 'tier_id', the character length must be smaller than or equal to 10.";
        }

        if ((mb_strlen($this->container['tier_id']) < 10)) {
            $invalidProperties[] = "invalid value for 'tier_id', the character length must be bigger than or equal to 10.";
        }
    ...
    public function setTierNumber($tier_number)
    {
        ...
        if (!is_null($tier_number) && (mb_strlen($tier_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_number when calling MSMembershipTierHistory., must be bigger than or equal to 1.');
        }
    ...
    public function setTierName($tier_name)
    {
        ...
        if (!is_null($tier_name) && (mb_strlen($tier_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_name when calling MSMembershipTierHistory., must be bigger than or equal to 1.');
        }
    ...
    public function setTierDiscount($tier_discount)
    {
        ...
        if (!is_null($tier_discount) && ($tier_discount > 100)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling MSMembershipTierHistory., must be smaller than or equal to 100.');
        }
        if (!is_null($tier_discount) && ($tier_discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling MSMembershipTierHistory., must be bigger than or equal to 0.');
        }
    ...
    public function setTierDesignId($tier_design_id)
    {
        ...
        if ((mb_strlen($tier_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling MSMembershipTierHistory., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($tier_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling MSMembershipTierHistory., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($tier_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$tier_design_id when calling MSMembershipTierHistory., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPointsDesignId($points_design_id)
    {
        ...
        if ((mb_strlen($points_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling MSMembershipTierHistory., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($points_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling MSMembershipTierHistory., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($points_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$points_design_id when calling MSMembershipTierHistory., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling MSMembershipTierHistory., must be smaller than or equal to 36.');
        }
        if (!is_null($id) && (mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling MSMembershipTierHistory., must be bigger than or equal to 36.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling MSMembershipTierHistory., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling MSMembershipTierHistory., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling MSMembershipTierHistory., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets tier_id
     *
     * @param mixed $tier_id The id of the membership tier - autopopulated by the service
     *
     * @return self
     */
    public function setTierId($tier_id)
    {
        ...
        if (!is_null($tier_id) && (mb_strlen($tier_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_id when calling MSMembershipTierHistory., must be smaller than or equal to 10.');
        }
        if (!is_null($tier_id) && (mb_strlen($tier_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_id when calling MSMembershipTierHistory., must be bigger than or equal to 10.');
        }
