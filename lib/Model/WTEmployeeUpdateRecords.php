...
/**
 * WTEmployeeUpdateRecords Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTEmployeeUpdateRecords implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTEmployeeUpdateRecords';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling WTEmployeeUpdateRecords., must be bigger than or equal to 1.');
        }
    ...
    public function setBucket($bucket)
    {
        ...
        if (!is_null($bucket) && (mb_strlen($bucket) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bucket when calling WTEmployeeUpdateRecords., must be bigger than or equal to 1.');
        }
