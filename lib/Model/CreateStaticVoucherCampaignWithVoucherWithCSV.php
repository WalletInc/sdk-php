...
class CreateStaticVoucherCampaignWithVoucherWithCSV implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['campaign_group_id']) && (mb_strlen($this->container['campaign_group_id']) > 12)) {
            $invalidProperties[] = "invalid value for 'campaign_group_id', the character length must be smaller than or equal to 12.";
        }
     ...
     *
     * @param mixed $expiration_date_time expiration_date_time
     *
     * @return self
     */
    ...
    public function setCampaignGroupId($campaign_group_id)
    {
        ...
        if ((mb_strlen($campaign_group_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $campaign_group_id when calling CreateStaticVoucherCampaignWithVoucherWithCSV., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($campaign_group_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $campaign_group_id when calling CreateStaticVoucherCampaignWithVoucherWithCSV., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($campaign_group_id)))) {
            throw new \InvalidArgumentException("invalid value for \$campaign_group_id when calling CreateStaticVoucherCampaignWithVoucherWithCSV., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
