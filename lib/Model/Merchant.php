...
class Merchant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'max_sms_count' => 'mixed',
        'max_phone_numbers' => 'mixed',
        'subaccount_sid' => 'mixed',
    ...
    protected static $setters = [
        ...
        'max_phone_numbers' => 'setMaxPhoneNumbers',
        'subaccount_sid' => 'setSubaccountSid',
    ...
    protected static $getters = [
        ...
        'max_phone_numbers' => 'getMaxPhoneNumbers',
        'subaccount_sid' => 'getSubaccountSid',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('max_phone_numbers', $data ?? [], null);
        $this->setIfExists('subaccount_sid', $data ?? [], null);
    ...
    */
     ...
     * Sets is_closed
     *
     * @param mixed $is_closed is_closed
     *
     * @return self
     */
    ...
    /**
     * Gets max_phone_numbers
     *
     * @return mixed|null
     */
    public function getMaxPhoneNumbers()
    {
        return $this->container['max_phone_numbers'];
    }

    /**
     * Sets max_phone_numbers
     *
     * @param mixed|null $max_phone_numbers max_phone_numbers
     *
     * @return self
     */
    public function setMaxPhoneNumbers($max_phone_numbers)
    {
        if (is_null($max_phone_numbers)) {
            array_push($this->openAPINullablesSetToNull, 'max_phone_numbers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_phone_numbers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['max_phone_numbers'] = $max_phone_numbers;
     ...
     * @return mixed|null
     */
    public function getSubaccountSid()
    {
        return $this->container['subaccount_sid'];
    }

    /**
     * Sets subaccount_sid
     *
     * @param mixed|null $subaccount_sid subaccount_sid
     *
     * @return self
     */
    public function setSubaccountSid($subaccount_sid)
    {
        if (is_null($subaccount_sid)) {
            array_push($this->openAPINullablesSetToNull, 'subaccount_sid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('subaccount_sid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['subaccount_sid'] = $subaccount_sid;
