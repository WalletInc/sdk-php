...
/**
 * WTWalletObjectPrefixCounts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTWalletObjectPrefixCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTWalletObjectPrefixCounts';
    ...
    protected static $openAPITypes = [
        ...
        'list' => '\OpenAPI\Client\Model\WTWalletPageViewCount[]'
    ];
     ...
     * Gets list
     *
     * @return \OpenAPI\Client\Model\WTWalletPageViewCount[]
     */
     ...
     * Sets list
     *
     * @param \OpenAPI\Client\Model\WTWalletPageViewCount[] $list list
     *
     * @return self
     */
