...
/**
 * WTStaticVoucher Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTStaticVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTStaticVoucher';
    ...
    protected static $openAPITypes = [
        ...
        'date_time_last_viewed' => 'mixed',
        'reason_invalid' => 'mixed'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'updated_at' => false,
        'is_active' => false,
        'authorized_amount_decimal' => true,
        'authorized_amount_string' => true,
        'offer_amount_cents_decimal' => true,
        'offer_amount_cents_string' => true,
        'redeemed_amount_decimal' => true,
        'redeemed_amount_string' => true,
        'date_time_redeemed' => true,
        'date_time_refunded' => true,
        'date_time_last_viewed' => true,
        'reason_invalid' => true
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offer_amount_cents_string', $data ?? [], null);
        ...
        $this->setIfExists('date_time_last_viewed', $data ?? [], null);
        $this->setIfExists('reason_invalid', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCampaignId($campaign_id)
    {
        ...
        if ((mb_strlen($campaign_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $campaign_id when calling WTStaticVoucher., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($campaign_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $campaign_id when calling WTStaticVoucher., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($campaign_id)))) {
            throw new \InvalidArgumentException("invalid value for \$campaign_id when calling WTStaticVoucher., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]*$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling WTStaticVoucher., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
    ...
    public function setOfferAmountCents($offer_amount_cents)
    {
        ...
        if (($offer_amount_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $offer_amount_cents when calling WTStaticVoucher., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling WTStaticVoucher., must be bigger than or equal to 0.');
        }
    ...
    public function setRedeemedAmount($redeemed_amount)
    {
        ...
        if (($redeemed_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $redeemed_amount when calling WTStaticVoucher., must be bigger than or equal to 0.');
        }
    ...
    public function setRefundedAmount($refunded_amount)
    {
        ...
        if (($refunded_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $refunded_amount when calling WTStaticVoucher., must be bigger than or equal to 0.');
        }
    ...
    public function setAuthorizedAmount($authorized_amount)
    {
        ...
        if (($authorized_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $authorized_amount when calling WTStaticVoucher., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTStaticVoucher., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTStaticVoucher., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling WTStaticVoucher., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @param mixed $authorized_amount_decimal authorized_amount_decimal
     *
     * @return self
     */
    public function setAuthorizedAmountDecimal($authorized_amount_decimal)
    {
        if (is_null($authorized_amount_decimal)) {
            array_push($this->openAPINullablesSetToNull, 'authorized_amount_decimal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('authorized_amount_decimal', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param mixed $authorized_amount_string authorized_amount_string
     *
     * @return self
     */
    public function setAuthorizedAmountString($authorized_amount_string)
    {
        if (is_null($authorized_amount_string)) {
            array_push($this->openAPINullablesSetToNull, 'authorized_amount_string');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('authorized_amount_string', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $offer_amount_cents_decimal offer_amount_cents_decimal
     *
     * @return self
     */
    public function setOfferAmountCentsDecimal($offer_amount_cents_decimal)
    {
        if (is_null($offer_amount_cents_decimal)) {
            array_push($this->openAPINullablesSetToNull, 'offer_amount_cents_decimal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('offer_amount_cents_decimal', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $offer_amount_cents_string offer_amount_cents_string
     *
     * @return self
     */
    public function setOfferAmountCentsString($offer_amount_cents_string)
    {
        if (is_null($offer_amount_cents_string)) {
            array_push($this->openAPINullablesSetToNull, 'offer_amount_cents_string');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('offer_amount_cents_string', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $date_time_redeemed date_time_redeemed
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $date_time_refunded date_time_refunded
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $date_time_last_viewed date_time_last_viewed
     *
     * @return self
     */
    public function setDateTimeLastViewed($date_time_last_viewed)
    {
        if (is_null($date_time_last_viewed)) {
            array_push($this->openAPINullablesSetToNull, 'date_time_last_viewed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('date_time_last_viewed', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets reason_invalid
     *
     * @param mixed|null $reason_invalid reason_invalid
     *
     * @return self
     */
    public function setReasonInvalid($reason_invalid)
    {
        if (is_null($reason_invalid)) {
            array_push($this->openAPINullablesSetToNull, 'reason_invalid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reason_invalid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
