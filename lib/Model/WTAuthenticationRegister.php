...
class WTAuthenticationRegister implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'phone_number' => 'mixed',
        'ein' => 'mixed',
        'accepted_terms_version' => 'mixed',
        'accepted_privacy_version' => 'mixed',
        'utm_source' => 'mixed',
        'utm_medium' => 'mixed',
        'utm_term' => 'mixed',
        'utm_content' => 'mixed',
    ...
    protected static $attributeMap = [
        ...
        'ads_consent_declined' => 'ads_consent_declined',
    ...
    protected static $setters = [
        ...
        'accepted_privacy_version' => 'setAcceptedPrivacyVersion',
        ...
        'ads_consent_declined' => 'setAdsConsentDeclined',
    ...
    protected static $getters = [
        ...
        'accepted_privacy_version' => 'getAcceptedPrivacyVersion',
        ...
        'ads_consent_declined' => 'getAdsConsentDeclined',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accepted_privacy_version', $data ?? [], null);
        ...
        $this->setIfExists('ads_consent_declined', $data ?? [], null);
    ...
    */
     ...
     *
     * @param mixed|null $accepted_terms_version accepted_terms_version
     *
     * @return self
     */
    public function setAcceptedTermsVersion($accepted_terms_version)
    {
        if (is_null($accepted_terms_version)) {
            array_push($this->openAPINullablesSetToNull, 'accepted_terms_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accepted_terms_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets accepted_privacy_version
     *
     * @return mixed|null
     */
    public function getAcceptedPrivacyVersion()
    {
        return $this->container['accepted_privacy_version'];
    }

    /**
     * Sets accepted_privacy_version
     *
     * @param mixed|null $accepted_privacy_version accepted_privacy_version
     *
     * @return self
     */
    public function setAcceptedPrivacyVersion($accepted_privacy_version)
    {
        if (is_null($accepted_privacy_version)) {
            array_push($this->openAPINullablesSetToNull, 'accepted_privacy_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accepted_privacy_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['accepted_privacy_version'] = $accepted_privacy_version;
    ...
    /**
     * Gets ads_consent_declined
     *
     * @return mixed|null
     */
    public function getAdsConsentDeclined()
    {
        return $this->container['ads_consent_declined'];
    }

    /**
     * Sets ads_consent_declined
     *
     * @param mixed|null $ads_consent_declined ads_consent_declined
     *
     * @return self
     */
    public function setAdsConsentDeclined($ads_consent_declined)
    {
        if (is_null($ads_consent_declined)) {
            array_push($this->openAPINullablesSetToNull, 'ads_consent_declined');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ads_consent_declined', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ads_consent_declined'] = $ads_consent_declined;
