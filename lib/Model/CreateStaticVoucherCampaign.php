...
class CreateStaticVoucherCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets file_name
     *
     * @param mixed|null $file_name file_name
     *
     * @return self
     */
    ...
    public function setCampaignGroupId($campaign_group_id)
    {
        ...
        if ((mb_strlen($campaign_group_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $campaign_group_id when calling CreateStaticVoucherCampaign., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($campaign_group_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $campaign_group_id when calling CreateStaticVoucherCampaign., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($campaign_group_id)))) {
            throw new \InvalidArgumentException("invalid value for \$campaign_group_id when calling CreateStaticVoucherCampaign., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
