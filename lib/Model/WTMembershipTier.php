...
class WTMembershipTier implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string $id The id of the membership tier - autopopulated by the service
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $id when calling WTMembershipTier., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling WTMembershipTier., must be bigger than or equal to 10.');
        }
