...
/**
 * WTMembershipTier Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTMembershipTier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTMembershipTier';
    ...
    */
     ...
     * Sets tier_number
     *
     * @param mixed $tier_number The tier number as defined by the merchant
     *
     * @return self
     */
    public function setTierNumber($tier_number)
    {
        if (is_null($tier_number)) {
            array_push($this->openAPINullablesSetToNull, 'tier_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tier_number', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($tier_number) && (mb_strlen($tier_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_number when calling WTMembershipTier., must be bigger than or equal to 1.');
        }
     ...
     * Sets tier_name
     *
     * @param mixed $tier_name The tier name as defined by the merchant
     *
     * @return self
     */
    public function setTierName($tier_name)
    {
        if (is_null($tier_name)) {
            array_push($this->openAPINullablesSetToNull, 'tier_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tier_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($tier_name) && (mb_strlen($tier_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_name when calling WTMembershipTier., must be bigger than or equal to 1.');
        }
     ...
     * Sets tier_discount
     *
     * @param mixed $tier_discount The provided discount as percentage
     *
     * @return self
     */
    public function setTierDiscount($tier_discount)
    {
        if (is_null($tier_discount)) {
            array_push($this->openAPINullablesSetToNull, 'tier_discount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tier_discount', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($tier_discount) && ($tier_discount > 100)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling WTMembershipTier., must be smaller than or equal to 100.');
        }
        if (!is_null($tier_discount) && ($tier_discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling WTMembershipTier., must be bigger than or equal to 0.');
        }
    ...
    public function setTierDesignId($tier_design_id)
    {
        ...
        if ((mb_strlen($tier_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling WTMembershipTier., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($tier_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling WTMembershipTier., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($tier_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$tier_design_id when calling WTMembershipTier., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPointsDesignId($points_design_id)
    {
        ...
        if ((mb_strlen($points_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling WTMembershipTier., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($points_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling WTMembershipTier., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($points_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$points_design_id when calling WTMembershipTier., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Gets id
     *
     * @return \OpenAPI\Client\Model\WTMembershipTierId
     */
     ...
     * Sets id
     *
     * @param \OpenAPI\Client\Model\WTMembershipTierId $id id
     *
     * @return self
     */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTMembershipTier., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTMembershipTier., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling WTMembershipTier., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets created_at
     *
     * @param mixed $created_at The timestamp of when this resource was created
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param mixed $updated_at The timestamp of when this resource was updated
     *
     * @return self
     */
