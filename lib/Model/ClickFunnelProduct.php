...
class ClickFunnelProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'subject' => false,
        'html_body' => false,
        'thank_you_page_id' => false,
        'stripe_cancel_after_payments' => true,
        'bump' => false,
        'cart_product_id' => true,
        'billing_integration' => false,
        'infusionsoft_product_id' => true,
        'infusionsoft_subscription_id' => true,
        'ontraport_product_id' => true,
        'ontraport_payment_count' => true,
        'ontraport_payment_type' => true,
        'ontraport_unit' => true,
        'ontraport_gateway_id' => true,
        'ontraport_invoice_id' => true,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('stripe_plan', $data ?? [], null);
        ...
        $this->setIfExists('thank_you_page_id', $data ?? [], null);
        $this->setIfExists('stripe_cancel_after_payments', $data ?? [], null);
        $this->setIfExists('bump', $data ?? [], null);
        $this->setIfExists('cart_product_id', $data ?? [], null);
        $this->setIfExists('billing_integration', $data ?? [], null);
        $this->setIfExists('infusionsoft_product_id', $data ?? [], null);
        $this->setIfExists('infusionsoft_subscription_id', $data ?? [], null);
        $this->setIfExists('ontraport_product_id', $data ?? [], null);
        $this->setIfExists('ontraport_payment_count', $data ?? [], null);
        $this->setIfExists('ontraport_payment_type', $data ?? [], null);
        $this->setIfExists('ontraport_unit', $data ?? [], null);
        $this->setIfExists('ontraport_gateway_id', $data ?? [], null);
        $this->setIfExists('ontraport_invoice_id', $data ?? [], null);
        $this->setIfExists('commissionable', $data ?? [], null);
        $this->setIfExists('statement_descriptor', $data ?? [], null);
        $this->setIfExists('netsuite_id', $data ?? [], null);
        $this->setIfExists('netsuite_tag', $data ?? [], null);
        $this->setIfExists('netsuite_class', $data ?? [], null);
    ...
    */
    ...
    public function setStripePlan($stripe_plan)
    {
        if (is_null($stripe_plan)) {
            throw new \InvalidArgumentException('non-nullable stripe_plan cannot be null');
        }
     ...
     *
     * @param float $thank_you_page_id thank_you_page_id
     *
     * @return self
     */
    public function setThankYouPageId($thank_you_page_id)
    {
        if (is_null($thank_you_page_id)) {
            throw new \InvalidArgumentException('non-nullable thank_you_page_id cannot be null');
        }
    ...
    {
        if (is_null($stripe_cancel_after_payments)) {
            array_push($this->openAPINullablesSetToNull, 'stripe_cancel_after_payments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('stripe_cancel_after_payments', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($bump)) {
            throw new \InvalidArgumentException('non-nullable bump cannot be null');
        }
    ...
    public function setCartProductId($cart_product_id)
    {
        if (is_null($cart_product_id)) {
            array_push($this->openAPINullablesSetToNull, 'cart_product_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cart_product_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($billing_integration)) {
            throw new \InvalidArgumentException('non-nullable billing_integration cannot be null');
        }
    ...
    {
        if (is_null($infusionsoft_product_id)) {
            array_push($this->openAPINullablesSetToNull, 'infusionsoft_product_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('infusionsoft_product_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($infusionsoft_subscription_id)) {
            array_push($this->openAPINullablesSetToNull, 'infusionsoft_subscription_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('infusionsoft_subscription_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_product_id)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_product_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_product_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_payment_count)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_payment_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_payment_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_payment_type)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_payment_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_payment_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_unit)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_unit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_unit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_gateway_id)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_gateway_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_gateway_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($ontraport_invoice_id)) {
            array_push($this->openAPINullablesSetToNull, 'ontraport_invoice_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ontraport_invoice_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($netsuite_id)) {
            array_push($this->openAPINullablesSetToNull, 'netsuite_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('netsuite_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($netsuite_tag)) {
            array_push($this->openAPINullablesSetToNull, 'netsuite_tag');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('netsuite_tag', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($netsuite_class)) {
            array_push($this->openAPINullablesSetToNull, 'netsuite_class');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('netsuite_class', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
