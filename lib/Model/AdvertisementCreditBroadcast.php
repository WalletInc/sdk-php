...
class AdvertisementCreditBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('advertisement_credit', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($advertisement_credit)) {
            throw new \InvalidArgumentException('non-nullable advertisement_credit cannot be null');
        }
