...
/**
 * WTAmenityCreateParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTAmenityCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTAmenityCreateParams';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WTAmenityCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WTAmenityCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayedPrice($displayed_price)
    {
        ...
        if (!is_null($displayed_price) && (mb_strlen($displayed_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $displayed_price when calling WTAmenityCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling WTAmenityCreateParams., must be bigger than or equal to 1.');
        }
