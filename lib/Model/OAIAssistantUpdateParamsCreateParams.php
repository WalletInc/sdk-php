...
/**
 * OAIAssistantUpdateParamsCreateParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OAIAssistantUpdateParamsCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAI_AssistantUpdateParamsCreateParams';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OAIAssistantUpdateParamsCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setInstructions($instructions)
    {
        ...
        if (!is_null($instructions) && (mb_strlen($instructions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $instructions when calling OAIAssistantUpdateParamsCreateParams., must be bigger than or equal to 1.');
        }
