...
class WTEmployeeScheduleSMSCampaignBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'locale' => 'mixed',
        'timezone' => 'mixed',
        'message_type' => '\OpenAPI\Client\Model\WTMessageType'
    ];
    ...
    */
    ...
    public function setMessageTemplate($message_template)
    {
        ...
        if (!is_null($message_template) && (mb_strlen($message_template) > 1600)) {
     ...
     * Sets send_qr_code
     *
     * @param mixed $send_qr_code send_qr_code
     *
     * @return self
     */
    public function setSendQrCode($send_qr_code)
    {
        if (is_null($send_qr_code)) {
            array_push($this->openAPINullablesSetToNull, 'send_qr_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('send_qr_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets message_type
     *
     * @return \OpenAPI\Client\Model\WTMessageType|null
     */
     ...
     * Sets message_type
     *
     * @param \OpenAPI\Client\Model\WTMessageType|null $message_type message_type
     *
     * @return self
     */
