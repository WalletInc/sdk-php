 ...
 */
class LinkBook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkBook';
    ...
    protected static $openAPITypes = [
        ...
        'icon' => 'mixed',
        'order_number' => 'int',
        'link_book_section_id' => '\OpenAPI\Client\Model\WTQuickLinkLinkBookSectionID',
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling LinkBook., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling LinkBook., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if (!is_null($icon) && (mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling LinkBook., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling LinkBook., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\WTQuickLinkLinkBookSectionID|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\WTQuickLinkLinkBookSectionID|null $link_book_section_id link_book_section_id
     *
     * @return self
     */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling LinkBook., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling LinkBook., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling LinkBook., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
