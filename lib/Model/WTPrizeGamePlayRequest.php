...
/**
 * WTPrizeGamePlayRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTPrizeGamePlayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTPrizeGamePlayRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['promotion_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'promotion_id', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets promotion_id
     *
     * @param mixed $promotion_id promotion_id
     *
     * @return self
     */
    public function setPromotionId($promotion_id)
    {
        ...
        if (!is_null($promotion_id) && (mb_strlen($promotion_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $promotion_id when calling WTPrizeGamePlayRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneVerificationToken($phone_verification_token)
    {
        ...
        if (!is_null($phone_verification_token) && (mb_strlen($phone_verification_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_verification_token when calling WTPrizeGamePlayRequest., must be bigger than or equal to 1.');
        }
