...
/**
 * SaveMerchantCreditPaymentDesignRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveMerchantCreditPaymentDesignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveMerchantCreditPaymentDesign_request';
    ...
    */
    ...
    public function setPaymentDesignId($payment_design_id)
    {
        ...
        if ((mb_strlen($payment_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling SaveMerchantCreditPaymentDesignRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling SaveMerchantCreditPaymentDesignRequest., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($payment_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_design_id when calling SaveMerchantCreditPaymentDesignRequest., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
