...
/**
 * PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID Class Doc Comment
 *
 * @category Class
 ...
 */
class PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_WTStaticVoucherCreateParams.Exclude_keyofWTStaticVoucherCreateParams.campaignID__';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]*$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
    ...
    public function setOfferAmountCents($offer_amount_cents)
    {
        ...
        if (($offer_amount_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $offer_amount_cents when calling PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID., must be bigger than or equal to 0.');
        }
    ...
    public function setCellPhone($cell_phone)
    {
        ...
        if ((mb_strlen($cell_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $cell_phone when calling PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID., must be bigger than or equal to 10.');
        }
