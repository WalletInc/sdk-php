 ...
 */
class OptInList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptInList';
    ...
    */
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling OptInList., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($employee_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling OptInList., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($employee_id)))) {
            throw new \InvalidArgumentException("invalid value for \$employee_id when calling OptInList., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setListName($list_name)
    {
        ...
        if ((mb_strlen($list_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $list_name when calling OptInList., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumberId($phone_number_id)
    {
        ...
        if ((mb_strlen($phone_number_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling OptInList., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($phone_number_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling OptInList., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($phone_number_id)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number_id when calling OptInList., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setEstimatedMessagesPerMonth($estimated_messages_per_month)
    {
        ...
        if (($estimated_messages_per_month < 0)) {
            throw new \InvalidArgumentException('invalid value for $estimated_messages_per_month when calling OptInList., must be bigger than or equal to 0.');
        }
    ...
    public function setOptInKeyword($opt_in_keyword)
    {
        ...
        if ((mb_strlen($opt_in_keyword) > 30)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_keyword when calling OptInList., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($opt_in_keyword) < 4)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_keyword when calling OptInList., must be bigger than or equal to 4.');
        }
    ...
    public function setOptOutKeyword($opt_out_keyword)
    {
        ...
        if ((mb_strlen($opt_out_keyword) > 34)) {
            throw new \InvalidArgumentException('invalid length for $opt_out_keyword when calling OptInList., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($opt_out_keyword) < 4)) {
            throw new \InvalidArgumentException('invalid length for $opt_out_keyword when calling OptInList., must be bigger than or equal to 4.');
        }
     ...
     *
     * @param mixed $opt_in_confirmed_media_urls opt_in_confirmed_media_urls
     *
     * @return self
     */
     ...
     *
     * @param mixed $opt_out_confirmed_media_urls opt_out_confirmed_media_urls
     *
     * @return self
     */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling OptInList., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling OptInList., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling OptInList., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
