...
class WTStaticVoucherCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['campaign_id']) > 12)) {
            $invalidProperties[] = "invalid value for 'campaign_id', the character length must be smaller than or equal to 12.";
        }
    ...
    {
        if ((mb_strlen($campaign_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $campaign_id when calling WTStaticVoucherCreateParams., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($campaign_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $campaign_id when calling WTStaticVoucherCreateParams., must be bigger than or equal to 10.');
        }
