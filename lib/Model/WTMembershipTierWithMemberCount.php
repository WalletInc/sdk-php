...
/**
 * WTMembershipTierWithMemberCount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTMembershipTierWithMemberCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTMembershipTierWithMemberCount';
    ...
    public function setTierNumber($tier_number)
    {
        ...
        if ((mb_strlen($tier_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_number when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 1.');
        }
    ...
    public function setTierName($tier_name)
    {
        ...
        if ((mb_strlen($tier_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tier_name when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 1.');
        }
    ...
    public function setTierDiscount($tier_discount)
    {
        ...
        if (($tier_discount > 100)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling WTMembershipTierWithMemberCount., must be smaller than or equal to 100.');
        }
        if (($tier_discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $tier_discount when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 0.');
        }
    ...
    public function setTierDesignId($tier_design_id)
    {
        if ((mb_strlen($tier_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling WTMembershipTierWithMemberCount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($tier_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $tier_design_id when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $tier_design_id))) {
            throw new \InvalidArgumentException("invalid value for $tier_design_id when calling WTMembershipTierWithMemberCount., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPointsDesignId($points_design_id)
    {
        if ((mb_strlen($points_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling WTMembershipTierWithMemberCount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($points_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $points_design_id when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $points_design_id))) {
            throw new \InvalidArgumentException("invalid value for $points_design_id when calling WTMembershipTierWithMemberCount., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    {
        if ((mb_strlen($id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $id when calling WTMembershipTierWithMemberCount., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 10.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTMembershipTierWithMemberCount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling WTMembershipTierWithMemberCount., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $merchant_id))) {
            throw new \InvalidArgumentException("invalid value for $merchant_id when calling WTMembershipTierWithMemberCount., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Sets member_count
     *
     * @param int $member_count Describes the count of members associated with this membership tier
     *
     * @return self
     */
