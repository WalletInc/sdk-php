...
class WTDynamicVoucherCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'decrease_amount' => 'int',
        'frequency' => 'int',
        'frequency_type' => '\OpenAPI\Client\Model\DynamicVoucherTemporalDecreaseFrequencyType',
        'decrease_by' => 'float',
        'decrease_every' => 'float'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'date_time_expiration' => false,
        'starting_value' => false,
        'max_budget' => false,
        'decrease_amount' => false,
        'frequency' => false,
        'frequency_type' => false,
        'decrease_by' => false,
        'decrease_every' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('date_time_start', $data ?? [], null);
        $this->setIfExists('date_time_expiration', $data ?? [], null);
        $this->setIfExists('starting_value', $data ?? [], null);
        $this->setIfExists('max_budget', $data ?? [], null);
        $this->setIfExists('decrease_amount', $data ?? [], null);
        $this->setIfExists('frequency', $data ?? [], null);
        $this->setIfExists('frequency_type', $data ?? [], null);
        $this->setIfExists('decrease_by', $data ?? [], null);
        $this->setIfExists('decrease_every', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($date_time_start)) {
            throw new \InvalidArgumentException('non-nullable date_time_start cannot be null');
        }
    ...
    {
        if (is_null($date_time_expiration)) {
            throw new \InvalidArgumentException('non-nullable date_time_expiration cannot be null');
        }
    ...
    {
        if (is_null($decrease_amount)) {
            throw new \InvalidArgumentException('non-nullable decrease_amount cannot be null');
        }
     ...
     * Sets frequency_type
     *
     * @param \OpenAPI\Client\Model\DynamicVoucherTemporalDecreaseFrequencyType $frequency_type frequency_type
     *
     * @return self
     */
    public function setFrequencyType($frequency_type)
    {
        if (is_null($frequency_type)) {
            throw new \InvalidArgumentException('non-nullable frequency_type cannot be null');
        }
     ...
     * Sets decrease_by
     *
     * @param float|null $decrease_by decrease_by
     *
     * @return self
     */
    public function setDecreaseBy($decrease_by)
    {
        if (is_null($decrease_by)) {
            throw new \InvalidArgumentException('non-nullable decrease_by cannot be null');
        }
    ...
    {
        if (is_null($decrease_every)) {
            throw new \InvalidArgumentException('non-nullable decrease_every cannot be null');
        }
