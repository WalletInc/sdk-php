...
class MSMerchantCreditRedemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets transaction_id
     *
     * @param mixed $transaction_id The transaction ID at the POS
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param mixed $amount The number of amount involved in this transaction
     *
     * @return self
     */
     ...
     * Gets register_id
     *
     * @return \OpenAPI\Client\Model\MSMemberRedemptionRegisterID|null
     */
     ...
     * Sets register_id
     *
     * @param \OpenAPI\Client\Model\MSMemberRedemptionRegisterID|null $register_id register_id
     *
     * @return self
     */
     ...
     * Sets terminal_type
     *
     * @param mixed $terminal_type The type of the terminal
     *
     * @return self
     */
    public function setTerminalType($terminal_type)
    {
        if (is_null($terminal_type)) {
            array_push($this->openAPINullablesSetToNull, 'terminal_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('terminal_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($terminal_type) && (mb_strlen($terminal_type) < 1)) {
