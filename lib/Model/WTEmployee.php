...
class WTEmployee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'merchant_id' => 'string',
        'session_token' => 'mixed',
        'failed_login_attempts' => 'mixed',
        'last_login_date' => 'mixed',
        'cfuvid' => 'mixed',
        'schedule' => 'object',
        'is_email_notification_disabled' => 'mixed',
        'chrome_theme' => '\OpenAPI\Client\Model\EmployeeChromeTheme',
        'is_page_tips_disabled' => 'mixed'
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_page_tips_disabled' => 'isPageTipsDisabled'
    ];
    ...
    protected static $setters = [
        ...
        'chrome_theme' => 'setChromeTheme',
        'is_page_tips_disabled' => 'setIsPageTipsDisabled'
    ];
    ...
    protected static $getters = [
        ...
        'chrome_theme' => 'getChromeTheme',
        'is_page_tips_disabled' => 'getIsPageTipsDisabled'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chrome_theme', $data ?? [], null);
        $this->setIfExists('is_page_tips_disabled', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param mixed $is_public_representative is_public_representative
     *
     * @return self
     */
    public function setIsPublicRepresentative($is_public_representative)
    {
        if (is_null($is_public_representative)) {
            array_push($this->openAPINullablesSetToNull, 'is_public_representative');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_public_representative', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $wallet_sequence_number wallet_sequence_number
     *
     * @return self
     */
    public function setWalletSequenceNumber($wallet_sequence_number)
    {
        if (is_null($wallet_sequence_number)) {
            array_push($this->openAPINullablesSetToNull, 'wallet_sequence_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('wallet_sequence_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if (!is_null($employee_id) && (mb_strlen($employee_id) < 0)) {
     ...
     * Sets email_verified
     *
     * @param mixed $email_verified email_verified
     *
     * @return self
     */
     ...
     * Sets session_token
     *
     * @param mixed $session_token session_token
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $failed_login_attempts failed_login_attempts
     *
     * @return self
     */
    public function setFailedLoginAttempts($failed_login_attempts)
    {
        if (is_null($failed_login_attempts)) {
            array_push($this->openAPINullablesSetToNull, 'failed_login_attempts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('failed_login_attempts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $last_login_date last_login_date
     *
     * @return self
     */
     ...
     * Sets cfuvid
     *
     * @param mixed|null $cfuvid cfuvid
     *
     * @return self
     */
    ...
    {
        if (is_null($cfuvid)) {
            array_push($this->openAPINullablesSetToNull, 'cfuvid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cfuvid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets schedule
     *
     * @param object|null $schedule Construct a type with a set of properties K of type T
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $is_email_notification_disabled is_email_notification_disabled
     *
     * @return self
     */
    public function setIsEmailNotificationDisabled($is_email_notification_disabled)
    {
        if (is_null($is_email_notification_disabled)) {
            array_push($this->openAPINullablesSetToNull, 'is_email_notification_disabled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_email_notification_disabled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets chrome_theme
     *
     * @return \OpenAPI\Client\Model\EmployeeChromeTheme|null
     */
    public function getChromeTheme()
    {
        return $this->container['chrome_theme'];
    }

    /**
     * Sets chrome_theme
     *
     * @param \OpenAPI\Client\Model\EmployeeChromeTheme|null $chrome_theme chrome_theme
     *
     * @return self
     */
    public function setChromeTheme($chrome_theme)
    {
        if (is_null($chrome_theme)) {
            throw new \InvalidArgumentException('non-nullable chrome_theme cannot be null');
        }
        $this->container['chrome_theme'] = $chrome_theme;

        return $this;
    }

    /**
     * Gets is_page_tips_disabled
     *
     * @return mixed|null
     */
    public function getIsPageTipsDisabled()
    {
        return $this->container['is_page_tips_disabled'];
    }

    /**
     * Sets is_page_tips_disabled
     *
     * @param mixed|null $is_page_tips_disabled is_page_tips_disabled
     *
     * @return self
     */
    public function setIsPageTipsDisabled($is_page_tips_disabled)
    {
        if (is_null($is_page_tips_disabled)) {
            array_push($this->openAPINullablesSetToNull, 'is_page_tips_disabled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_page_tips_disabled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_page_tips_disabled'] = $is_page_tips_disabled;
