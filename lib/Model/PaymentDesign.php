...
/**
 * PaymentDesign Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentDesign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDesign';
    ...
    */
    ...
    public function setBorderColor($border_color)
    {
        ...
        if ((!preg_match("/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/", ObjectSerializer::toString($border_color)))) {
            throw new \InvalidArgumentException("invalid value for \$border_color when calling PaymentDesign., must conform to the pattern /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.");
        }
    ...
    public function setBorderSize($border_size)
    {
        ...
        if ((mb_strlen($border_size) < 1)) {
            throw new \InvalidArgumentException('invalid length for $border_size when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setBorderRadius($border_radius)
    {
        ...
        if (($border_radius > 20)) {
            throw new \InvalidArgumentException('invalid value for $border_radius when calling PaymentDesign., must be smaller than or equal to 20.');
        }
        if (($border_radius < 0)) {
            throw new \InvalidArgumentException('invalid value for $border_radius when calling PaymentDesign., must be bigger than or equal to 0.');
        }
    ...
    public function setFontColor($font_color)
    {
        ...
        if ((!preg_match("/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/", ObjectSerializer::toString($font_color)))) {
            throw new \InvalidArgumentException("invalid value for \$font_color when calling PaymentDesign., must conform to the pattern /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.");
        }
    ...
    public function setFontType($font_type)
    {
        ...
        if ((mb_strlen($font_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $font_type when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setAbbreviation($abbreviation)
    {
        ...
        if ((mb_strlen($abbreviation) < 1)) {
            throw new \InvalidArgumentException('invalid length for $abbreviation when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setAcronym($acronym)
    {
        ...
        if ((mb_strlen($acronym) < 1)) {
            throw new \InvalidArgumentException('invalid length for $acronym when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setDesignName($design_name)
    {
        ...
        if ((mb_strlen($design_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $design_name when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling PaymentDesign., must be bigger than or equal to 1.');
        }
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling PaymentDesign., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($employee_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling PaymentDesign., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($employee_id)))) {
            throw new \InvalidArgumentException("invalid value for \$employee_id when calling PaymentDesign., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling PaymentDesign., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling PaymentDesign., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling PaymentDesign., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
