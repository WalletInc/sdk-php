...
class PaymentDesign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if ((mb_strlen($id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDesign., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDesign., must be bigger than or equal to 10.');
        }
