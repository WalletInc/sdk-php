...
/**
 * WTSMSImportedListCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTSMSImportedListCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTSMSImportedListCreate';
    ...
    */
    ...
    public function setPhoneNumberId($phone_number_id)
    {
        ...
        if ((mb_strlen($phone_number_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling WTSMSImportedListCreate., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($phone_number_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling WTSMSImportedListCreate., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($phone_number_id)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number_id when calling WTSMSImportedListCreate., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setListName($list_name)
    {
        ...
        if (!is_null($list_name) && (mb_strlen($list_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $list_name when calling WTSMSImportedListCreate., must be bigger than or equal to 1.');
        }
