...
/**
 * WTPerformanceCreateParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTPerformanceCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTPerformanceCreateParams';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WTPerformanceCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setBody($body)
    {
        ...
        if (!is_null($body) && (mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling WTPerformanceCreateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (!is_null($order_number) && ($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling WTPerformanceCreateParams., must be bigger than or equal to 1.');
        }
