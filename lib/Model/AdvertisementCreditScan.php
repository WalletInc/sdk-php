...
/**
 * AdvertisementCreditScan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdvertisementCreditScan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdvertisementCreditScan';
    ...
    */
    ...
    public function setRedeemedAmount($redeemed_amount)
    {
        ...
        if (($redeemed_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $redeemed_amount when calling AdvertisementCreditScan., must be bigger than or equal to 0.');
        }
    ...
    public function setRefundedAmount($refunded_amount)
    {
        ...
        if (($refunded_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $refunded_amount when calling AdvertisementCreditScan., must be bigger than or equal to 0.');
        }
    ...
    public function setAuthorizedAmount($authorized_amount)
    {
        ...
        if (($authorized_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $authorized_amount when calling AdvertisementCreditScan., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling AdvertisementCreditScan., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling AdvertisementCreditScan., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling AdvertisementCreditScan., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setAdvertisementCreditId($advertisement_credit_id)
    {
        ...
        if ((mb_strlen($advertisement_credit_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $advertisement_credit_id when calling AdvertisementCreditScan., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($advertisement_credit_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $advertisement_credit_id when calling AdvertisementCreditScan., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($advertisement_credit_id)))) {
            throw new \InvalidArgumentException("invalid value for \$advertisement_credit_id when calling AdvertisementCreditScan., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @param mixed $date_time_redeemed date_time_redeemed
     *
     * @return self
     */
     ...
     *
     * @param mixed $date_time_refunded date_time_refunded
     *
     * @return self
     */
