...
class Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets xml_output
     *
     * @param mixed $xml_output xml_output
     *
     * @return self
     */
    public function setXmlOutput($xml_output)
    {
        if (is_null($xml_output)) {
            array_push($this->openAPINullablesSetToNull, 'xml_output');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('xml_output', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets has_error
     *
     * @param mixed $has_error has_error
     *
     * @return self
     */
    public function setHasError($has_error)
    {
        if (is_null($has_error)) {
            array_push($this->openAPINullablesSetToNull, 'has_error');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('has_error', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
