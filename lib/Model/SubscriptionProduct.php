...
class SubscriptionProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'volume' => 'mixed',
        'value' => 'mixed',
        'value_basis' => '\OpenAPI\Client\Model\SubscriptionProductValueBasis',
        'features' => 'mixed',
        'pages' => 'mixed',
        'icon_name' => 'mixed',
        'description' => 'mixed',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('value_basis', $data ?? [], null);
    ...
    */
     ...
     * Gets value_basis
     *
     * @return \OpenAPI\Client\Model\SubscriptionProductValueBasis|null
     */
    public function getValueBasis()
    {
        return $this->container['value_basis'];
    }

    /**
     * Sets value_basis
     *
     * @param \OpenAPI\Client\Model\SubscriptionProductValueBasis|null $value_basis value_basis
     *
     * @return self
     */
    public function setValueBasis($value_basis)
    {
        if (is_null($value_basis)) {
            throw new \InvalidArgumentException('non-nullable value_basis cannot be null');
        }
        $this->container['value_basis'] = $value_basis;
