...
class SubscriptionProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets title_full
     *
     * @param string $title_full title_full
     *
     * @return self
     */
    public function setTitleFull($title_full)
    {
        if (is_null($title_full)) {
            throw new \InvalidArgumentException('non-nullable title_full cannot be null');
        }
     ...
     * Gets features
     *
     * @return \OpenAPI\Client\Model\SubscriptionFeature[]
     */
     ...
     * Sets features
     *
     * @param \OpenAPI\Client\Model\SubscriptionFeature[] $features features
     *
     * @return self
     */
     ...
     * Sets pages
     *
     * @param \OpenAPI\Client\Model\PortalPage[] $pages pages
     *
     * @return self
     */
     ...
     * Sets is_hourly
     *
     * @param bool|null $is_hourly is_hourly
     *
     * @return self
     */
    public function setIsHourly($is_hourly)
    {
        if (is_null($is_hourly)) {
            throw new \InvalidArgumentException('non-nullable is_hourly cannot be null');
        }
