...
class PhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setMessageFooter($message_footer)
    {
        ...
        if (!is_null($message_footer) && (mb_strlen($message_footer) < 1)) {
     ...
     *
     * @param mixed $privacy_policy_url privacy_policy_url
     *
     * @return self
     */
     ...
     *
     * @param mixed $terms_of_service_url terms_of_service_url
     *
     * @return self
     */
     ...
     *
     * @param mixed $is_connected_to_watson is_connected_to_watson
     *
     * @return self
     */
     ...
     *
     * @param mixed $watson_conversation_workplace_id watson_conversation_workplace_id
     *
     * @return self
     */
     ...
     *
     * @param mixed $watson_username watson_username
     *
     * @return self
     */
     ...
     *
     * @param mixed $watson_password watson_password
     *
     * @return self
     */
     ...
     * Sets is_short_code
     *
     * @param mixed $is_short_code is_short_code
     *
     * @return self
     */
    public function setIsShortCode($is_short_code)
    {
        if (is_null($is_short_code)) {
            array_push($this->openAPINullablesSetToNull, 'is_short_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_short_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets twilio_sid
     *
     * @param mixed $twilio_sid twilio_sid
     *
     * @return self
     */
    public function setTwilioSid($twilio_sid)
    {
        if (is_null($twilio_sid)) {
            array_push($this->openAPINullablesSetToNull, 'twilio_sid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('twilio_sid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed $twilio_account_sid twilio_account_sid
     *
     * @return self
     */
    public function setTwilioAccountSid($twilio_account_sid)
    {
        if (is_null($twilio_account_sid)) {
            array_push($this->openAPINullablesSetToNull, 'twilio_account_sid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('twilio_account_sid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_approved
     *
     * @param mixed $is_approved is_approved
     *
     * @return self
     */
    public function setIsApproved($is_approved)
    {
        if (is_null($is_approved)) {
            array_push($this->openAPINullablesSetToNull, 'is_approved');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_approved', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
