...
/**
 * WTAmenityUpdateParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTAmenityUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTAmenityUpdateParams';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WTAmenityUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WTAmenityUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayValue($display_value)
    {
        ...
        if ((mb_strlen($display_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_value when calling WTAmenityUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling WTAmenityUpdateParams., must be bigger than or equal to 1.');
        }
