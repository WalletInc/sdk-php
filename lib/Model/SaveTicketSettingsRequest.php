...
class SaveTicketSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payment_design_id']) > 12)) {
            $invalidProperties[] = "invalid value for 'payment_design_id', the character length must be smaller than or equal to 12.";
        }
    ...
    public function setPaymentDesignId($payment_design_id)
    {
        ...
        if ((mb_strlen($payment_design_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling SaveTicketSettingsRequest., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($payment_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling SaveTicketSettingsRequest., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($payment_design_id)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_design_id when calling SaveTicketSettingsRequest., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
