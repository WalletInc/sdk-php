...
/**
 * PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier Class Doc Comment
 *
 * @category Class
 ...
 */
class PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_MSMemberCreationParams.Exclude_keyofMSMemberCreationParams.memberIdentifier__';
    ...
    */
    ...
    public function setMembershipTierId($membership_tier_id)
    {
        ...
        if ((mb_strlen($membership_tier_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $membership_tier_id when calling PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($membership_tier_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $membership_tier_id when calling PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($membership_tier_id)))) {
            throw new \InvalidArgumentException("invalid value for \$membership_tier_id when calling PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPointsAccrued($points_accrued)
    {
        ...
        if (($points_accrued < 0)) {
            throw new \InvalidArgumentException('invalid value for $points_accrued when calling PickMSMemberCreationParamsExcludeKeyofMSMemberCreationParamsMemberIdentifier., must be bigger than or equal to 0.');
        }
