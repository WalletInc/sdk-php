...
/**
 * WTEmployeeCreateDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTEmployeeCreateDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTEmployeeCreateDocument';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling WTEmployeeCreateDocument., must be bigger than or equal to 1.');
        }
