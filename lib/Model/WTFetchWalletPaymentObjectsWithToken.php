...
class WTFetchWalletPaymentObjectsWithToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets page_type
     *
     * @param mixed $page_type page_type
     *
     * @return self
     */
     ...
     * Sets is_refresh
     *
     * @param mixed|null $is_refresh is_refresh
     *
     * @return self
     */
    public function setIsRefresh($is_refresh)
    {
        if (is_null($is_refresh)) {
            array_push($this->openAPINullablesSetToNull, 'is_refresh');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_refresh', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
