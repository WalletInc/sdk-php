...
class MSMemberHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param mixed $member_identifier Member ID as represented by the merchant
     *
     * @return self
     */
    public function setMemberIdentifier($member_identifier)
    {
        if (is_null($member_identifier)) {
            array_push($this->openAPINullablesSetToNull, 'member_identifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('member_identifier', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($member_identifier) && (mb_strlen($member_identifier) < 1)) {
        ...
        if (!is_null($member_identifier) && (!preg_match("^[a-zA-Z0-9]+$", ObjectSerializer::toString($member_identifier)))) {
     ...
     * Sets id
     *
     * @param mixed $id The UUID of this record
     *
     * @return self
     */
