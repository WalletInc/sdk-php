...
class MemberSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets search_value
     *
     * @param mixed $search_value The search value to be queried
     *
     * @return self
     */
    public function setSearchValue($search_value)
    {
        if (is_null($search_value)) {
            array_push($this->openAPINullablesSetToNull, 'search_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('search_value', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
