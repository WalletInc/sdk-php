...
/**
 * PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday Class Doc Comment
 *
 * @category Class
 ...
 */
class PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_WTMember.memberID-or-firstName-or-lastName-or-membershipTierID-or-pointsAccrued-or-mobileNumber-or-email-or-birthday_';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((mb_strlen($member_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $member_id when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setMembershipTierId($membership_tier_id)
    {
        ...
        if ((mb_strlen($membership_tier_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $membership_tier_id when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($membership_tier_id) < 12)) {
            throw new \InvalidArgumentException('invalid length for $membership_tier_id when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($membership_tier_id)))) {
            throw new \InvalidArgumentException("invalid value for \$membership_tier_id when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPointsAccrued($points_accrued)
    {
        ...
        if (($points_accrued < 0)) {
            throw new \InvalidArgumentException('invalid value for $points_accrued when calling PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumberOrEmailOrBirthday., must be bigger than or equal to 0.');
        }
