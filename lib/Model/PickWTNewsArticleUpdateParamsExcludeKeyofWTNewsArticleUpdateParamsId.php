...
/**
 * PickWTNewsArticleUpdateParamsExcludeKeyofWTNewsArticleUpdateParamsId Class Doc Comment
 *
 * @category Class
 ...
 */
class PickWTNewsArticleUpdateParamsExcludeKeyofWTNewsArticleUpdateParamsId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_WTNewsArticleUpdateParams.Exclude_keyofWTNewsArticleUpdateParams.id__';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PickWTNewsArticleUpdateParamsExcludeKeyofWTNewsArticleUpdateParamsId., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling PickWTNewsArticleUpdateParamsExcludeKeyofWTNewsArticleUpdateParamsId., must be bigger than or equal to 1.');
        }
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling PickWTNewsArticleUpdateParamsExcludeKeyofWTNewsArticleUpdateParamsId., must be bigger than or equal to 1.');
        }
