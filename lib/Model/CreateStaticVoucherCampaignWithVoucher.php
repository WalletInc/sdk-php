...
/**
 * CreateStaticVoucherCampaignWithVoucher Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateStaticVoucherCampaignWithVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStaticVoucherCampaignWithVoucher';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateStaticVoucherCampaignWithVoucher., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentDesignId($payment_design_id)
    {
        if ((mb_strlen($payment_design_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling CreateStaticVoucherCampaignWithVoucher., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_design_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_design_id when calling CreateStaticVoucherCampaignWithVoucher., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $payment_design_id))) {
            throw new \InvalidArgumentException("invalid value for $payment_design_id when calling CreateStaticVoucherCampaignWithVoucher., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setMemberId($member_id)
    {
        ...
        if (!is_null($member_id) && (!preg_match("/^[a-zA-Z0-9]*$/", $member_id))) {
            throw new \InvalidArgumentException("invalid value for $member_id when calling CreateStaticVoucherCampaignWithVoucher., must conform to the pattern /^[a-zA-Z0-9]*$/.");
        }
    ...
    public function setOfferAmountCents($offer_amount_cents)
    {
        ...
        if (($offer_amount_cents < 0)) {
            throw new \InvalidArgumentException('invalid value for $offer_amount_cents when calling CreateStaticVoucherCampaignWithVoucher., must be bigger than or equal to 0.');
        }
