...
/**
 * WTLinkBookUpdateParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WTLinkBookUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WTLinkBookUpdateParams';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WTLinkBookUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WTLinkBookUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling WTLinkBookUpdateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if (($order_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_number when calling WTLinkBookUpdateParams., must be bigger than or equal to 1.');
        }
