...
/**
 * SimpleSMSBroadcast Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SimpleSMSBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimpleSMSBroadcast';
    ...
    protected static $openAPITypes = [
        ...
        'payment_object_prefix' => '\OpenAPI\Client\Model\StaticVoucherCampaignBroadcastPaymentObjectPrefix',
        ...
        'updated_at' => 'mixed',
        'is_active' => 'mixed',
        'broadcast_status' => '\OpenAPI\Client\Model\StaticVoucherCampaignBroadcastBroadcastStatus',
    ...
    */
    ...
    public function setPhoneNumberId($phone_number_id)
    {
        ...
        if ((mb_strlen($phone_number_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling SimpleSMSBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($phone_number_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling SimpleSMSBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($phone_number_id)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number_id when calling SimpleSMSBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\StaticVoucherCampaignBroadcastPaymentObjectPrefix
     */
     ...
     *
     * @param \OpenAPI\Client\Model\StaticVoucherCampaignBroadcastPaymentObjectPrefix $payment_object_prefix payment_object_prefix
     *
     * @return self
     */
    ...
    public function setPaymentObjectId($payment_object_id)
    {
        ...
        if ((mb_strlen($payment_object_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_id when calling SimpleSMSBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_object_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_id when calling SimpleSMSBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($payment_object_id)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_object_id when calling SimpleSMSBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @param mixed $message_template message_template
     *
     * @return self
     */
    public function setMessageTemplate($message_template)
    {
        if (is_null($message_template)) {
            array_push($this->openAPINullablesSetToNull, 'message_template');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('message_template', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling SimpleSMSBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($employee_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling SimpleSMSBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($employee_id)))) {
            throw new \InvalidArgumentException("invalid value for \$employee_id when calling SimpleSMSBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @param mixed $broadcast_scheduled_at broadcast_scheduled_at
     *
     * @return self
     */
    public function setBroadcastScheduledAt($broadcast_scheduled_at)
    {
        if (is_null($broadcast_scheduled_at)) {
            array_push($this->openAPINullablesSetToNull, 'broadcast_scheduled_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('broadcast_scheduled_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling SimpleSMSBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling SimpleSMSBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($merchant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_id when calling SimpleSMSBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\StaticVoucherCampaignBroadcastBroadcastStatus
     */
     ...
     *
     * @param \OpenAPI\Client\Model\StaticVoucherCampaignBroadcastBroadcastStatus $broadcast_status broadcast_status
     *
     * @return self
     */
     ...
     *
     * @param mixed $broadcast_queued_at broadcast_queued_at
     *
     * @return self
     */
     ...
     *
     * @param mixed $broadcast_started_at broadcast_started_at
     *
     * @return self
     */
     ...
     *
     * @param mixed $broadcast_completed_at broadcast_completed_at
     *
     * @return self
     */
    ...
    public function setListId($list_id)
    {
        ...
        if ((mb_strlen($list_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $list_id when calling SimpleSMSBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($list_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $list_id when calling SimpleSMSBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($list_id)))) {
            throw new \InvalidArgumentException("invalid value for \$list_id when calling SimpleSMSBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
