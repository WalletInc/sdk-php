...
/**
 * StaticVoucherCampaignBroadcast Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StaticVoucherCampaignBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaticVoucherCampaignBroadcast';
    ...
    protected static $openAPITypes = [
        ...
        'static_voucher_campaign' => '\OpenAPI\Client\Model\StaticVoucherCampaign'
    ];
    ...
    {
        if ((mb_strlen($id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $id when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 10.');
        }
    ...
    public function setEmployeeId($employee_id)
    {
        if ((mb_strlen($employee_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($employee_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $employee_id))) {
            throw new \InvalidArgumentException("invalid value for $employee_id when calling StaticVoucherCampaignBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setMerchantId($merchant_id)
    {
        if ((mb_strlen($merchant_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($merchant_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $merchant_id))) {
            throw new \InvalidArgumentException("invalid value for $merchant_id when calling StaticVoucherCampaignBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPhoneNumberId($phone_number_id)
    {
        if ((mb_strlen($phone_number_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($phone_number_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_id when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id))) {
            throw new \InvalidArgumentException("invalid value for $phone_number_id when calling StaticVoucherCampaignBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function setPaymentObjectPrefix($payment_object_prefix)
    {
        if ((mb_strlen($payment_object_prefix) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_prefix when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payment_object_prefix) < 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_prefix when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 2.');
        }
    ...
    public function setPaymentObjectId($payment_object_id)
    {
        if ((mb_strlen($payment_object_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_id when calling StaticVoucherCampaignBroadcast., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_object_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_object_id when calling StaticVoucherCampaignBroadcast., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $payment_object_id))) {
            throw new \InvalidArgumentException("invalid value for $payment_object_id when calling StaticVoucherCampaignBroadcast., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\StaticVoucherCampaign
     */
     ...
     *
     * @param \OpenAPI\Client\Model\StaticVoucherCampaign $static_voucher_campaign static_voucher_campaign
     *
     * @return self
     */
