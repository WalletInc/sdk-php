...
class StaticVoucherCampaignBroadcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('static_voucher_campaign', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($static_voucher_campaign)) {
            throw new \InvalidArgumentException('non-nullable static_voucher_campaign cannot be null');
        }
