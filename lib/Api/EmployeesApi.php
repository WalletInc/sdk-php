...
class EmployeesApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\WTEmployeeCreateAlert $wt_employee_create_alert wt_employee_create_alert (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Alert|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError
     */
    public function createAlert($wt_employee_create_alert)
    {
        list($response) = $this->createAlertWithHttpInfo($wt_employee_create_alert);
        return $response;
    }
     ...
     * Create employee alert
     *
     * @param  \OpenAPI\Client\Model\WTEmployeeCreateAlert $wt_employee_create_alert (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Alert|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAlertWithHttpInfo($wt_employee_create_alert)
    {
        $request = $this->createAlertRequest($wt_employee_create_alert);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAlertAsync($wt_employee_create_alert)
    {
        return $this->createAlertAsyncWithHttpInfo($wt_employee_create_alert)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAlertAsyncWithHttpInfo($wt_employee_create_alert)
    {
        $returnType = '\OpenAPI\Client\Model\Alert';
        $request = $this->createAlertRequest($wt_employee_create_alert);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createAlertRequest($wt_employee_create_alert)
    {
        // verify the required parameter 'wt_employee_create_alert' is set
        if ($wt_employee_create_alert === null || (is_array($wt_employee_create_alert) && count($wt_employee_create_alert) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wt_employee_create_alert when calling createAlert'
            );
        }

        $resourcePath = '/v2/employee/alert';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($wt_employee_create_alert)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($wt_employee_create_alert));
            } else {
                $httpBody = $wt_employee_create_alert;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \OpenAPI\Client\Model\OptInListSource[]|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError
     */
    public function fetchOptInListSources()
    {
        list($response) = $this->fetchOptInListSourcesWithHttpInfo();
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\OptInListSource[]|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchOptInListSourcesWithHttpInfo()
    {
        $request = $this->fetchOptInListSourcesRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchOptInListSourcesAsync()
    {
        return $this->fetchOptInListSourcesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchOptInListSourcesAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\OptInListSource[]';
        $request = $this->fetchOptInListSourcesRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchOptInListSourcesRequest()
    {
