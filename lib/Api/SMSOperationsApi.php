...
/**
 * SMSOperationsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SMSOperationsApi
{
    ...
    public function archivePhoneNumberRequest($phone_number_id, string $contentType = self::contentTypes['archivePhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.archivePhoneNumber, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.archivePhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.archivePhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function archiveRecipientRequest($id, string $contentType = self::contentTypes['archiveRecipient'][0])
    {
        ...
        if (strlen($id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling SMSOperationsApi.archiveRecipient, must be smaller than or equal to 10.');
        }
        if (strlen($id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling SMSOperationsApi.archiveRecipient, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling SMSOperationsApi.archiveRecipient, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function countImportedListRecipientsRequest($list_id, $is_archive_included = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['countImportedListRecipients'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.countImportedListRecipients, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.countImportedListRecipients, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.countImportedListRecipients, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function countOptInListSubscribersRequest($list_id, $is_subscribed = null, $is_pending_age21_verification = null, $is_archive_included = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['countOptInListSubscribers'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.countOptInListSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.countOptInListSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.countOptInListSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function countOptInSourceSubscribersRequest($source_id, $is_subscribed = null, $is_pending_age21_verification = null, $is_archive_included = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['countOptInSourceSubscribers'][0])
    {
        ...
        if (strlen($source_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.countOptInSourceSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($source_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.countOptInSourceSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $source_id)) {
            throw new \InvalidArgumentException("invalid value for \"source_id\" when calling SMSOperationsApi.countOptInSourceSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function countOutboundSMSRequest($phone_number_id, $to_phone_number = null, $status = null, $payment_object_broadcast_id = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['countOutboundSMS'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.countOutboundSMS, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.countOutboundSMS, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.countOutboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
        


        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.countOutboundSMS, must be smaller than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.countOutboundSMS, must be bigger than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && !preg_match("/^[a-zA-Z0-9]+$/", $payment_object_broadcast_id)) {
            throw new \InvalidArgumentException("invalid value for \"payment_object_broadcast_id\" when calling SMSOperationsApi.countOutboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function exportImportedListRecipientsRequest($imported_list_id, string $contentType = self::contentTypes['exportImportedListRecipients'][0])
    {
        ...
        if (strlen($imported_list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$imported_list_id" when calling SMSOperationsApi.exportImportedListRecipients, must be smaller than or equal to 10.');
        }
        if (strlen($imported_list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$imported_list_id" when calling SMSOperationsApi.exportImportedListRecipients, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $imported_list_id)) {
            throw new \InvalidArgumentException("invalid value for \"imported_list_id\" when calling SMSOperationsApi.exportImportedListRecipients, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function exportOptInListSubscribersRequest($list_id, string $contentType = self::contentTypes['exportOptInListSubscribers'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.exportOptInListSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.exportOptInListSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.exportOptInListSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchBlockedTCPAEntriesRequest($phone_number_id, string $contentType = self::contentTypes['fetchBlockedTCPAEntries'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchBlockedTCPAEntries, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchBlockedTCPAEntries, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchBlockedTCPAEntries, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchImportedListRecipientsRequest($list_id, string $contentType = self::contentTypes['fetchImportedListRecipients'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchImportedListRecipients, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchImportedListRecipients, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.fetchImportedListRecipients, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchImportedListRecipientsByPageRequest($list_id, $page_size = null, $page_num = null, $is_archive_included = null, string $contentType = self::contentTypes['fetchImportedListRecipientsByPage'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchImportedListRecipientsByPage, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchImportedListRecipientsByPage, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.fetchImportedListRecipientsByPage, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInListSubscribersRequest($list_id, $is_subscribed = null, $is_pending_age21_verification = null, $is_archive_included = null, string $contentType = self::contentTypes['fetchOptInListSubscribers'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchOptInListSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchOptInListSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.fetchOptInListSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInListSubscribersByPageRequest($list_id, $page_size = null, $page_num = null, $is_subscribed = null, $is_pending_age21_verification = null, $is_archive_included = null, string $contentType = self::contentTypes['fetchOptInListSubscribersByPage'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchOptInListSubscribersByPage, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.fetchOptInListSubscribersByPage, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.fetchOptInListSubscribersByPage, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInListsAssociatedWithPhoneNumberRequest($phone_number_id, string $contentType = self::contentTypes['fetchOptInListsAssociatedWithPhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOptInListsAssociatedWithPhoneNumber, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOptInListsAssociatedWithPhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchOptInListsAssociatedWithPhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInSourceSubscribersRequest($source_id, $is_subscribed = null, $is_pending_age21_verification = null, $is_archive_included = null, string $contentType = self::contentTypes['fetchOptInSourceSubscribers'][0])
    {
        ...
        if (strlen($source_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.fetchOptInSourceSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($source_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.fetchOptInSourceSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $source_id)) {
            throw new \InvalidArgumentException("invalid value for \"source_id\" when calling SMSOperationsApi.fetchOptInSourceSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInSourcesAssociatedWithPhoneNumberRequest($phone_number_id, string $contentType = self::contentTypes['fetchOptInSourcesAssociatedWithPhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOptInSourcesAssociatedWithPhoneNumber, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOptInSourcesAssociatedWithPhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchOptInSourcesAssociatedWithPhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOutboundSMSRequest($phone_number_id, $to_phone_number = null, $status = null, $payment_object_broadcast_id = null, string $contentType = self::contentTypes['fetchOutboundSMS'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOutboundSMS, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOutboundSMS, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchOutboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
        


        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.fetchOutboundSMS, must be smaller than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.fetchOutboundSMS, must be bigger than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && !preg_match("/^[a-zA-Z0-9]+$/", $payment_object_broadcast_id)) {
            throw new \InvalidArgumentException("invalid value for \"payment_object_broadcast_id\" when calling SMSOperationsApi.fetchOutboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOutboundSMSByPageRequest($phone_number_id, $to_phone_number = null, $payment_object_broadcast_id = null, $page_size = null, $page_num = null, $status = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['fetchOutboundSMSByPage'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOutboundSMSByPage, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchOutboundSMSByPage, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchOutboundSMSByPage, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
        

        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.fetchOutboundSMSByPage, must be smaller than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && strlen($payment_object_broadcast_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$payment_object_broadcast_id" when calling SMSOperationsApi.fetchOutboundSMSByPage, must be bigger than or equal to 10.');
        }
        if ($payment_object_broadcast_id !== null && !preg_match("/^[a-zA-Z0-9]+$/", $payment_object_broadcast_id)) {
            throw new \InvalidArgumentException("invalid value for \"payment_object_broadcast_id\" when calling SMSOperationsApi.fetchOutboundSMSByPage, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchPaymentObjectBroadcastsRequest($phone_number_id, string $contentType = self::contentTypes['fetchPaymentObjectBroadcasts'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchPaymentObjectBroadcasts, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.fetchPaymentObjectBroadcasts, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.fetchPaymentObjectBroadcasts, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function importImportedListRecipientsRequest($imported_list_id, $wt_employee_import_records, string $contentType = self::contentTypes['importImportedListRecipients'][0])
    {
        ...
        if (strlen($imported_list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$imported_list_id" when calling SMSOperationsApi.importImportedListRecipients, must be smaller than or equal to 10.');
        }
        if (strlen($imported_list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$imported_list_id" when calling SMSOperationsApi.importImportedListRecipients, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $imported_list_id)) {
            throw new \InvalidArgumentException("invalid value for \"imported_list_id\" when calling SMSOperationsApi.importImportedListRecipients, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function importOptInListSubscribersRequest($list_id, $wtsms_import_opt_in_list_subscribers, string $contentType = self::contentTypes['importOptInListSubscribers'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.importOptInListSubscribers, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.importOptInListSubscribers, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.importOptInListSubscribers, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function restorePhoneNumberRequest($phone_number_id, string $contentType = self::contentTypes['restorePhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.restorePhoneNumber, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.restorePhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.restorePhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function restoreRecipientRequest($id, string $contentType = self::contentTypes['restoreRecipient'][0])
    {
        ...
        if (strlen($id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling SMSOperationsApi.restoreRecipient, must be smaller than or equal to 10.');
        }
        if (strlen($id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling SMSOperationsApi.restoreRecipient, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling SMSOperationsApi.restoreRecipient, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function saveImportedListRequest($list_id, $wtsms_imported_list_create, string $contentType = self::contentTypes['saveImportedList'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.saveImportedList, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.saveImportedList, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.saveImportedList, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function saveOptInListRequest($list_id, $wt_opt_in_list_creation_params, string $contentType = self::contentTypes['saveOptInList'][0])
    {
        ...
        if (strlen($list_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.saveOptInList, must be smaller than or equal to 10.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling SMSOperationsApi.saveOptInList, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling SMSOperationsApi.saveOptInList, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function saveOptInListSourceRequest($source_id, $wtsms_opt_in_list_source_create, string $contentType = self::contentTypes['saveOptInListSource'][0])
    {
        ...
        if (strlen($source_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.saveOptInListSource, must be smaller than or equal to 10.');
        }
        if (strlen($source_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$source_id" when calling SMSOperationsApi.saveOptInListSource, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $source_id)) {
            throw new \InvalidArgumentException("invalid value for \"source_id\" when calling SMSOperationsApi.saveOptInListSource, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function sendPhoneNumberForVerificationRequest($phone_number_id, $wtsms_update_phone_number_config, string $contentType = self::contentTypes['sendPhoneNumberForVerification'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.sendPhoneNumberForVerification, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.sendPhoneNumberForVerification, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.sendPhoneNumberForVerification, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function updatePhoneNumberRequest($phone_number_id, $wtsms_update_phone_number_config, string $contentType = self::contentTypes['updatePhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.updatePhoneNumber, must be smaller than or equal to 10.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling SMSOperationsApi.updatePhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling SMSOperationsApi.updatePhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
