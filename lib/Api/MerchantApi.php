...
class MerchantApi
{
    ...
    public function archivePaymentObjectBroadcastRequest($broadcast_id, string $contentType = self::contentTypes['archivePaymentObjectBroadcast'][0])
    {
        ...
        if (strlen($broadcast_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$broadcast_id" when calling MerchantApi.archivePaymentObjectBroadcast, must be smaller than or equal to 12.');
        }
        if (strlen($broadcast_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$broadcast_id" when calling MerchantApi.archivePaymentObjectBroadcast, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $broadcast_id)) {
            throw new \InvalidArgumentException("invalid value for \"broadcast_id\" when calling MerchantApi.archivePaymentObjectBroadcast, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function countInboundSMSRequest($phone_number_id, $from_phone_number = null, $body = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['countInboundSMS'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.countInboundSMS, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.countInboundSMS, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.countInboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchHelpDeskRequestsRequest($phone_number_id, $is_resolved = null, string $contentType = self::contentTypes['fetchHelpDeskRequests'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchHelpDeskRequests, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchHelpDeskRequests, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.fetchHelpDeskRequests, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchImportedListRequest($list_id, string $contentType = self::contentTypes['fetchImportedList'][0])
    {
        ...
        if (strlen($list_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling MerchantApi.fetchImportedList, must be smaller than or equal to 12.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling MerchantApi.fetchImportedList, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling MerchantApi.fetchImportedList, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchInboundSMSRequest($phone_number_id, $from_phone_number = null, string $contentType = self::contentTypes['fetchInboundSMS'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchInboundSMS, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchInboundSMS, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.fetchInboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchInboundSMSByPageRequest($phone_number_id, $from_phone_number = null, $page_size = null, $page_num = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['fetchInboundSMSByPage'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchInboundSMSByPage, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchInboundSMSByPage, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.fetchInboundSMSByPage, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchMerchantOutboundSMSRequest($phone_number_id, $to_phone_number, string $contentType = self::contentTypes['fetchMerchantOutboundSMS'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchMerchantOutboundSMS, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchMerchantOutboundSMS, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.fetchMerchantOutboundSMS, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchOptInListRequest($list_id, string $contentType = self::contentTypes['fetchOptInList'][0])
    {
        ...
        if (strlen($list_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling MerchantApi.fetchOptInList, must be smaller than or equal to 12.');
        }
        if (strlen($list_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$list_id" when calling MerchantApi.fetchOptInList, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $list_id)) {
            throw new \InvalidArgumentException("invalid value for \"list_id\" when calling MerchantApi.fetchOptInList, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
    ...
    public function fetchPhoneNumberRequest($phone_number_id, string $contentType = self::contentTypes['fetchPhoneNumber'][0])
    {
        ...
        if (strlen($phone_number_id) > 12) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchPhoneNumber, must be smaller than or equal to 12.');
        }
        if (strlen($phone_number_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$phone_number_id" when calling MerchantApi.fetchPhoneNumber, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $phone_number_id)) {
            throw new \InvalidArgumentException("invalid value for \"phone_number_id\" when calling MerchantApi.fetchPhoneNumber, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
