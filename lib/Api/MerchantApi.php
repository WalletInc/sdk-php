...
class MerchantApi
{
     ...
     * @return mixed|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError
     */
    public function updatePointsOfContact($wt_merchant_update_points_of_contact)
    {
        list($response) = $this->updatePointsOfContactWithHttpInfo($wt_merchant_update_points_of_contact);
        return $response;
    }
     ...
     * @return array of mixed|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePointsOfContactWithHttpInfo($wt_merchant_update_points_of_contact)
    {
        $request = $this->updatePointsOfContactRequest($wt_merchant_update_points_of_contact);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePointsOfContactAsync($wt_merchant_update_points_of_contact)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePointsOfContactAsyncWithHttpInfo($wt_merchant_update_points_of_contact)
    {
        $returnType = 'mixed';
        $request = $this->updatePointsOfContactRequest($wt_merchant_update_points_of_contact);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePointsOfContactRequest($wt_merchant_update_points_of_contact)
    {
        ...
        if (isset($wt_merchant_update_points_of_contact)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($wt_merchant_update_points_of_contact));
            } else {
