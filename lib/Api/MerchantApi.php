...
class MerchantApi
{
     ...
     * @return string|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError
     */
    public function exportOutboundMessages($phone_number_id, $locale)
    {
        list($response) = $this->exportOutboundMessagesWithHttpInfo($phone_number_id, $locale);
        return $response;
    }
     ...
     * @return array of string|\OpenAPI\Client\Model\AuthError|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function exportOutboundMessagesWithHttpInfo($phone_number_id, $locale)
    {
        $request = $this->exportOutboundMessagesRequest($phone_number_id, $locale);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportOutboundMessagesAsync($phone_number_id, $locale)
    {
        return $this->exportOutboundMessagesAsyncWithHttpInfo($phone_number_id, $locale)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportOutboundMessagesAsyncWithHttpInfo($phone_number_id, $locale)
    {
        $returnType = 'string';
        $request = $this->exportOutboundMessagesRequest($phone_number_id, $locale);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function exportOutboundMessagesRequest($phone_number_id, $locale)
    {
        // verify the required parameter 'phone_number_id' is set
        if ($phone_number_id === null || (is_array($phone_number_id) && count($phone_number_id) === 0)) {
            throw new \InvalidArgumentException(
