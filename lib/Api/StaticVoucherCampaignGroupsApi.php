...
class StaticVoucherCampaignGroupsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchStaticVoucherCampaignGroups'] to see the possible values for this operation
     *
     ...
     */
    public function fetchStaticVoucherCampaignGroups($campaigns_group_id, string $contentType = self::contentTypes['fetchStaticVoucherCampaignGroups'][0])
    {
        list($response) = $this->fetchStaticVoucherCampaignGroupsWithHttpInfo($campaigns_group_id, $contentType);
        return $response;
    }
     ...
     */
    public function fetchStaticVoucherCampaignGroupsWithHttpInfo($campaigns_group_id, string $contentType = self::contentTypes['fetchStaticVoucherCampaignGroups'][0])
    {
        $request = $this->fetchStaticVoucherCampaignGroupsRequest($campaigns_group_id, $contentType);
     ...
     */
    public function fetchStaticVoucherCampaignGroupsAsync($campaigns_group_id, string $contentType = self::contentTypes['fetchStaticVoucherCampaignGroups'][0])
    {
        return $this->fetchStaticVoucherCampaignGroupsAsyncWithHttpInfo($campaigns_group_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchStaticVoucherCampaignGroupsAsyncWithHttpInfo($campaigns_group_id, string $contentType = self::contentTypes['fetchStaticVoucherCampaignGroups'][0])
    {
        $returnType = 'object';
        $request = $this->fetchStaticVoucherCampaignGroupsRequest($campaigns_group_id, $contentType);
     ...
     */
    public function fetchStaticVoucherCampaignGroupsRequest($campaigns_group_id, string $contentType = self::contentTypes['fetchStaticVoucherCampaignGroups'][0])
    {
