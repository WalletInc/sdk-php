...
class InteractionsApi
{
    ...
    /**
     * Operation createGuestDonation
     *
     * Create a guest tip / donation PaymentIntent (KAN-861)
     *
     * @param  \OpenAPI\Client\Model\WTGuestDonationRequest $wt_guest_donation_request wt_guest_donation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestDonation'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500
     */
    public function createGuestDonation($wt_guest_donation_request, string $contentType = self::contentTypes['createGuestDonation'][0])
    {
        list($response) = $this->createGuestDonationWithHttpInfo($wt_guest_donation_request, $contentType);
        return $response;
    }

    /**
     * Operation createGuestDonationWithHttpInfo
     *
     * Create a guest tip / donation PaymentIntent (KAN-861)
     *
     * @param  \OpenAPI\Client\Model\WTGuestDonationRequest $wt_guest_donation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestDonation'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function createGuestDonationWithHttpInfo($wt_guest_donation_request, string $contentType = self::contentTypes['createGuestDonation'][0])
    {
        $request = $this->createGuestDonationRequest($wt_guest_donation_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation createGuestDonationAsync
     *
     * Create a guest tip / donation PaymentIntent (KAN-861)
     *
     * @param  \OpenAPI\Client\Model\WTGuestDonationRequest $wt_guest_donation_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGuestDonationAsync($wt_guest_donation_request, string $contentType = self::contentTypes['createGuestDonation'][0])
    {
        return $this->createGuestDonationAsyncWithHttpInfo($wt_guest_donation_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createGuestDonationAsyncWithHttpInfo
     *
     * Create a guest tip / donation PaymentIntent (KAN-861)
     *
     * @param  \OpenAPI\Client\Model\WTGuestDonationRequest $wt_guest_donation_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGuestDonationAsyncWithHttpInfo($wt_guest_donation_request, string $contentType = self::contentTypes['createGuestDonation'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse';
        $request = $this->createGuestDonationRequest($wt_guest_donation_request, $contentType);
    ...
    /**
     * Create request for operation 'createGuestDonation'
     *
     * @param  \OpenAPI\Client\Model\WTGuestDonationRequest $wt_guest_donation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestDonation'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createGuestDonationRequest($wt_guest_donation_request, string $contentType = self::contentTypes['createGuestDonation'][0])
    {

        // verify the required parameter 'wt_guest_donation_request' is set
        if ($wt_guest_donation_request === null || (is_array($wt_guest_donation_request) && count($wt_guest_donation_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wt_guest_donation_request when calling createGuestDonation'
            );
        }


        $resourcePath = '/wallet/payments/donate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($wt_guest_donation_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($wt_guest_donation_request));
            } else {
                $httpBody = $wt_guest_donation_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation createGuestPaymentIntent
     *
     * Create a guest checkout PaymentIntent (KAN-802)
     *
     * @param  \OpenAPI\Client\Model\WTGuestCreatePaymentIntentRequest $wt_guest_create_payment_intent_request wt_guest_create_payment_intent_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestPaymentIntent'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500
     */
    public function createGuestPaymentIntent($wt_guest_create_payment_intent_request, string $contentType = self::contentTypes['createGuestPaymentIntent'][0])
    {
        list($response) = $this->createGuestPaymentIntentWithHttpInfo($wt_guest_create_payment_intent_request, $contentType);
        return $response;
    }

    /**
     * Operation createGuestPaymentIntentWithHttpInfo
     *
     * Create a guest checkout PaymentIntent (KAN-802)
     *
     * @param  \OpenAPI\Client\Model\WTGuestCreatePaymentIntentRequest $wt_guest_create_payment_intent_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestPaymentIntent'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function createGuestPaymentIntentWithHttpInfo($wt_guest_create_payment_intent_request, string $contentType = self::contentTypes['createGuestPaymentIntent'][0])
    {
        $request = $this->createGuestPaymentIntentRequest($wt_guest_create_payment_intent_request, $contentType);
    ...
    /**
     * Operation createGuestPaymentIntentAsync
     *
     * Create a guest checkout PaymentIntent (KAN-802)
     *
     * @param  \OpenAPI\Client\Model\WTGuestCreatePaymentIntentRequest $wt_guest_create_payment_intent_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGuestPaymentIntentAsync($wt_guest_create_payment_intent_request, string $contentType = self::contentTypes['createGuestPaymentIntent'][0])
    {
        return $this->createGuestPaymentIntentAsyncWithHttpInfo($wt_guest_create_payment_intent_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createGuestPaymentIntentAsyncWithHttpInfo
     *
     * Create a guest checkout PaymentIntent (KAN-802)
     *
     * @param  \OpenAPI\Client\Model\WTGuestCreatePaymentIntentRequest $wt_guest_create_payment_intent_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGuestPaymentIntentAsyncWithHttpInfo($wt_guest_create_payment_intent_request, string $contentType = self::contentTypes['createGuestPaymentIntent'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse';
        $request = $this->createGuestPaymentIntentRequest($wt_guest_create_payment_intent_request, $contentType);
    ...
    /**
     * Create request for operation 'createGuestPaymentIntent'
     *
     * @param  \OpenAPI\Client\Model\WTGuestCreatePaymentIntentRequest $wt_guest_create_payment_intent_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGuestPaymentIntent'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createGuestPaymentIntentRequest($wt_guest_create_payment_intent_request, string $contentType = self::contentTypes['createGuestPaymentIntent'][0])
    {

        // verify the required parameter 'wt_guest_create_payment_intent_request' is set
        if ($wt_guest_create_payment_intent_request === null || (is_array($wt_guest_create_payment_intent_request) && count($wt_guest_create_payment_intent_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wt_guest_create_payment_intent_request when calling createGuestPaymentIntent'
            );
        }


        $resourcePath = '/wallet/payments/createIntent';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($wt_guest_create_payment_intent_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($wt_guest_create_payment_intent_request));
            } else {
                $httpBody = $wt_guest_create_payment_intent_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation fetchActivePrizeGamePromotion
     *
     ...
     *
     * @param  string $merchant_id merchant_id (required)
     * @param  WTPrizeGameType $game_type game_type (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchActivePrizeGamePromotion'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WTPrizeGameActivePromotion|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500
     */
    public function fetchActivePrizeGamePromotion($merchant_id, $game_type, string $contentType = self::contentTypes['fetchActivePrizeGamePromotion'][0])
    {
        list($response) = $this->fetchActivePrizeGamePromotionWithHttpInfo($merchant_id, $game_type, $contentType);
        return $response;
    }

    /**
     * Operation fetchActivePrizeGamePromotionWithHttpInfo
     *
     * Get the active prize-game promotion Guest-facing read that drives the game UI and the Official Rules surface: sponsor (the merchant), title, honest odds disclosure, prize list, play limits, and the minimum age. Returns { active: false } when the merchant has no live promotion for the game.
     *
     * @param  string $merchant_id (required)
     * @param  WTPrizeGameType $game_type (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchActivePrizeGamePromotion'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WTPrizeGameActivePromotion|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchActivePrizeGamePromotionWithHttpInfo($merchant_id, $game_type, string $contentType = self::contentTypes['fetchActivePrizeGamePromotion'][0])
    {
        $request = $this->fetchActivePrizeGamePromotionRequest($merchant_id, $game_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WTPrizeGameActivePromotion' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WTPrizeGameActivePromotion' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WTPrizeGameActivePromotion', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\Client\Model\WTPrizeGameActivePromotion';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WTPrizeGameActivePromotion',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation fetchActivePrizeGamePromotionAsync
     *
     * Get the active prize-game promotion Guest-facing read that drives the game UI and the Official Rules surface: sponsor (the merchant), title, honest odds disclosure, prize list, play limits, and the minimum age. Returns { active: false } when the merchant has no live promotion for the game.
     *
     * @param  string $merchant_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchActivePrizeGamePromotionAsync($merchant_id, $game_type, string $contentType = self::contentTypes['fetchActivePrizeGamePromotion'][0])
    {
        return $this->fetchActivePrizeGamePromotionAsyncWithHttpInfo($merchant_id, $game_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fetchActivePrizeGamePromotionAsyncWithHttpInfo
     *
     * Get the active prize-game promotion Guest-facing read that drives the game UI and the Official Rules surface: sponsor (the merchant), title, honest odds disclosure, prize list, play limits, and the minimum age. Returns { active: false } when the merchant has no live promotion for the game.
     *
     * @param  string $merchant_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchActivePrizeGamePromotionAsyncWithHttpInfo($merchant_id, $game_type, string $contentType = self::contentTypes['fetchActivePrizeGamePromotion'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WTPrizeGameActivePromotion';
        $request = $this->fetchActivePrizeGamePromotionRequest($merchant_id, $game_type, $contentType);
    ...
    /**
     * Create request for operation 'fetchActivePrizeGamePromotion'
     *
     * @param  string $merchant_id (required)
     * @param  WTPrizeGameType $game_type (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchActivePrizeGamePromotion'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchActivePrizeGamePromotionRequest($merchant_id, $game_type, string $contentType = self::contentTypes['fetchActivePrizeGamePromotion'][0])
    {

        // verify the required parameter 'merchant_id' is set
        if ($merchant_id === null || (is_array($merchant_id) && count($merchant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_id when calling fetchActivePrizeGamePromotion'
            );
        }
        if (strlen($merchant_id) > 10) {
            throw new \InvalidArgumentException('invalid length for "$merchant_id" when calling InteractionsApi.fetchActivePrizeGamePromotion, must be smaller than or equal to 10.');
        }
        if (strlen($merchant_id) < 10) {
            throw new \InvalidArgumentException('invalid length for "$merchant_id" when calling InteractionsApi.fetchActivePrizeGamePromotion, must be bigger than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9]+$/", $merchant_id)) {
            throw new \InvalidArgumentException("invalid value for \"merchant_id\" when calling InteractionsApi.fetchActivePrizeGamePromotion, must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
        
        // verify the required parameter 'game_type' is set
        if ($game_type === null || (is_array($game_type) && count($game_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $game_type when calling fetchActivePrizeGamePromotion'
            );
        }


        $resourcePath = '/wallet/prizeGame/active/{merchantID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation fetchGuestOrder
     *
     * Fetch a guest order receipt (KAN-802)
     *
     * @param  string $id id (required)
     * @param  string $phone_verification_token phone_verification_token (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchGuestOrder'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WTGuestOrderReceipt|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500
     */
    public function fetchGuestOrder($id, $phone_verification_token, string $contentType = self::contentTypes['fetchGuestOrder'][0])
    {
        list($response) = $this->fetchGuestOrderWithHttpInfo($id, $phone_verification_token, $contentType);
        return $response;
    }

    /**
     * Operation fetchGuestOrderWithHttpInfo
     *
     * Fetch a guest order receipt (KAN-802)
     *
     * @param  string $id (required)
     * @param  string $phone_verification_token (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchGuestOrder'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WTGuestOrderReceipt|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchGuestOrderWithHttpInfo($id, $phone_verification_token, string $contentType = self::contentTypes['fetchGuestOrder'][0])
    {
        $request = $this->fetchGuestOrderRequest($id, $phone_verification_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WTGuestOrderReceipt' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WTGuestOrderReceipt' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WTGuestOrderReceipt', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\Client\Model\WTGuestOrderReceipt';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WTGuestOrderReceipt',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation fetchGuestOrderAsync
     *
     * Fetch a guest order receipt (KAN-802)
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchGuestOrderAsync($id, $phone_verification_token, string $contentType = self::contentTypes['fetchGuestOrder'][0])
    {
        return $this->fetchGuestOrderAsyncWithHttpInfo($id, $phone_verification_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fetchGuestOrderAsyncWithHttpInfo
     *
     * Fetch a guest order receipt (KAN-802)
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchGuestOrderAsyncWithHttpInfo($id, $phone_verification_token, string $contentType = self::contentTypes['fetchGuestOrder'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WTGuestOrderReceipt';
        $request = $this->fetchGuestOrderRequest($id, $phone_verification_token, $contentType);
    ...
    /**
     * Create request for operation 'fetchGuestOrder'
     *
     * @param  string $id (required)
     * @param  string $phone_verification_token (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fetchGuestOrder'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fetchGuestOrderRequest($id, $phone_verification_token, string $contentType = self::contentTypes['fetchGuestOrder'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling fetchGuestOrder'
            );
        }

        // verify the required parameter 'phone_verification_token' is set
        if ($phone_verification_token === null || (is_array($phone_verification_token) && count($phone_verification_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $phone_verification_token when calling fetchGuestOrder'
            );
        }


        $resourcePath = '/wallet/payments/order/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \OpenAPI\Client\Model\WTPrizeGamePlayRequest $wt_prize_game_play_request wt_prize_game_play_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['playPrizeGame'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WTPrizeGamePlayResult|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500
     */
    public function playPrizeGame($wt_prize_game_play_request, string $contentType = self::contentTypes['playPrizeGame'][0])
    {
        list($response) = $this->playPrizeGameWithHttpInfo($wt_prize_game_play_request, $contentType);
        return $response;
    }

    /**
     * Operation playPrizeGameWithHttpInfo
     *
     * Play a prize game Server-authoritative instant-win play (KAN-307): the server decides win/lose and the prize with a crypto-grade RNG, enforces the per-guest play limit and prize inventory, records the audited play with its odds snapshot, and on a win issues the prize into the guest&#39;s My Prizes via the existing Prize (Advertisement Credit) scan path. Requires the OTP-verified phone token; carries NO payment surface of any kind (plays are always free).
     *
     * @param  \OpenAPI\Client\Model\WTPrizeGamePlayRequest $wt_prize_game_play_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['playPrizeGame'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WTPrizeGamePlayResult|\OpenAPI\Client\Model\FalsumError|\OpenAPI\Client\Model\InternalServerError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function playPrizeGameWithHttpInfo($wt_prize_game_play_request, string $contentType = self::contentTypes['playPrizeGame'][0])
    {
        $request = $this->playPrizeGameRequest($wt_prize_game_play_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WTPrizeGamePlayResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WTPrizeGamePlayResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WTPrizeGamePlayResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\Client\Model\WTPrizeGamePlayResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WTPrizeGamePlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function playPrizeGameAsync($wt_prize_game_play_request, string $contentType = self::contentTypes['playPrizeGame'][0])
    {
        return $this->playPrizeGameAsyncWithHttpInfo($wt_prize_game_play_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation playPrizeGameAsyncWithHttpInfo
     *
     * Play a prize game Server-authoritative instant-win play (KAN-307): the server decides win/lose and the prize with a crypto-grade RNG, enforces the per-guest play limit and prize inventory, records the audited play with its odds snapshot, and on a win issues the prize into the guest&#39;s My Prizes via the existing Prize (Advertisement Credit) scan path. Requires the OTP-verified phone token; carries NO payment surface of any kind (plays are always free).
     *
     * @param  \OpenAPI\Client\Model\WTPrizeGamePlayRequest $wt_prize_game_play_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function playPrizeGameAsyncWithHttpInfo($wt_prize_game_play_request, string $contentType = self::contentTypes['playPrizeGame'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WTPrizeGamePlayResult';
        $request = $this->playPrizeGameRequest($wt_prize_game_play_request, $contentType);
    ...
    /**
     * Create request for operation 'playPrizeGame'
     *
     * @param  \OpenAPI\Client\Model\WTPrizeGamePlayRequest $wt_prize_game_play_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['playPrizeGame'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function playPrizeGameRequest($wt_prize_game_play_request, string $contentType = self::contentTypes['playPrizeGame'][0])
    {

        // verify the required parameter 'wt_prize_game_play_request' is set
        if ($wt_prize_game_play_request === null || (is_array($wt_prize_game_play_request) && count($wt_prize_game_play_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wt_prize_game_play_request when calling playPrizeGame'
            );
        }


        $resourcePath = '/wallet/prizeGame/play';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($wt_prize_game_play_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($wt_prize_game_play_request));
            } else {
                $httpBody = $wt_prize_game_play_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
