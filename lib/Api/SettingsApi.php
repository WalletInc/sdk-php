...
class SettingsApi
{
    ...
    {
        list($response) = $this->getActiveCampaignsWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getActiveCampaignsWithHttpInfo()
    {
        $request = $this->getActiveCampaignsRequest();
     ...
     */
    public function getActiveCampaignsAsync()
    {
        return $this->getActiveCampaignsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActiveCampaignsAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\StaticVoucherCampaign[]';
        $request = $this->getActiveCampaignsRequest();
     ...
     */
    public function getActiveCampaignsRequest()
    {
    ...
    {
        list($response) = $this->getVouchersCountWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getVouchersCountWithHttpInfo()
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersCountAsync()
    {
        return $this->getVouchersCountAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersCountAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\WTCountResult';
        $request = $this->getVouchersCountRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVouchersCountRequest()
    {
