...
| [**createGuestDonation()**](InteractionsApi.md#createGuestDonation) | **POST** /wallet/payments/donate | Create a guest tip / donation PaymentIntent (KAN-861) |
...
```php
createGuestDonation($wt_guest_donation_request): \OpenAPI\Client\Model\WTGuestCreatePaymentIntentResponse
```
...
$wt_guest_donation_request = new \OpenAPI\Client\Model\WTGuestDonationRequest(); // \OpenAPI\Client\Model\WTGuestDonationRequest

try {
    $result = $apiInstance->createGuestDonation($wt_guest_donation_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling InteractionsApi->createGuestDonation: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **wt_guest_donation_request** | [**\OpenAPI\Client\Model\WTGuestDonationRequest**](../Model/WTGuestDonationRequest.md)|  | |
