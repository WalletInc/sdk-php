# OpenAPI\Client\WalletMobileTerminalApi
...
$apiInstance = new OpenAPI\Client\Api\WalletMobileTerminalApi(
...
try {
    ...
    echo 'Exception when calling WalletMobileTerminalApi->fetchWalletItemFromMobileTerminal: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling WalletMobileTerminalApi->findMemberByID: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling WalletMobileTerminalApi->redeemWalletItemFromMobileTerminal: ', $e->getMessage(), PHP_EOL;
}
```
