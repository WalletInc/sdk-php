# OpenAPI\Client\WalletWebTerminalApi
...
$apiInstance = new OpenAPI\Client\Api\WalletWebTerminalApi(
...
try {
    ...
    echo 'Exception when calling WalletWebTerminalApi->fetchWalletItemFromWebTerminal: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling WalletWebTerminalApi->redeemWalletItemFromWebTerminal: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling WalletWebTerminalApi->refundWalletItemFromWebTerminal: ', $e->getMessage(), PHP_EOL;
}
```
