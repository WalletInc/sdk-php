...
**last_name** | **mixed** |  |
**email** | **mixed** |  |
**business_classification** | [**\OpenAPI\Client\Model\BusinessClassificationPublic**](BusinessClassificationPublic.md) |  |
...
**stock_ticker** | **string** |  |
**stock_exchange** | [**\OpenAPI\Client\Model\BusinessStockExchanges**](BusinessStockExchanges.md) |  |
